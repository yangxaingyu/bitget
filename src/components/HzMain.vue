      ...
      <div data-fetch-key="data-v-08a1c11c:0" class="portal-wrapper" data-v-08a1c11c>
        <div class="home" data-v-08a1c11c>
                                ...
                                <div data-v-71b06a1e data-v-3ded291d class>
                                  <div class="w-1/1 pad:w-full phone:w-full" data-v-71b06a1e>
                                    <div class="home-banner-login flex flex-col box-border text-v3PrimaryText font-400 leading-24px w-1/1 pc:mt-32px pad:w-full phone:w-full" data-v-55be6e78 data-v-71b06a1e>
                                      <span class="relative flex items-center text-20px leading-[140%] mr-8px cursor-pointer phone:text-12px phone:max-w-full phone:truncate" data-v-55be6e78><img src="../assets/img/topbanner_rewards_icon_black.svg" loading="lazy" alt="Bitget Register Rewards10.0643665874960695" class="w-24px h-24px align-bottom mr-8px phone:w-14px" style="display: none;" data-v-55be6e78> <img src="../assets/img/topbanner_rewards_icon_white.svg" loading="lazy" alt="Bitget Register Rewards20.08322935458827385" class="w-24px h-24px align-bottom mr-8px phone:w-14px" style data-v-55be6e78> <span data-v-55be6e78>Sign up now to claim a welcome pack of <span class="homepage-brand-color">6200 USDT</span>!</span></span>
                            ...
                            <div class="relative justify-between flex w-1200px mx-auto box-border <xl:w-full <xl:px-24px pad:flex-col pad:flex-col-reverse pad:justify-end pad:items-center pad:px-24px phone:justify-around phone:items-center phone:px-16px" data-v-3ded291d>
                              <div class="w-600px z-1 h-360px flex flex-col justify-start mt-80px box-border <xl:w-528px !pad:mt-16px !pad:w-full pad:h-302px !phone:w-full !phone:mt-0 phone:h-222px" data-v-3ded291d>
                                ...
                                <div data-v-71b06a1e data-v-3ded291d class>
                                  <div class="w-1/1 pad:w-full phone:w-full" data-v-71b06a1e>
                                    <div class="home-banner-login flex flex-col box-border text-v3PrimaryText font-400 leading-24px w-1/1 pc:mt-32px pad:w-full phone:w-full" data-v-55be6e78 data-v-71b06a1e>
                                      <span class="relative flex items-center text-20px leading-[140%] mr-8px cursor-pointer phone:text-12px phone:max-w-full phone:truncate" data-v-55be6e78><img src="../assets/img/topbanner_rewards_icon_black.svg" loading="lazy" alt="Bitget Register Rewards10.6431780374331608" class="w-24px h-24px align-bottom mr-8px phone:w-14px" style="display: none;" data-v-55be6e78> <img src="../assets/img/topbanner_rewards_icon_white.svg" loading="lazy" alt="Bitget Register Rewards20.47659121214864175" class="w-24px h-24px align-bottom mr-8px phone:w-14px" style data-v-55be6e78> <span data-v-55be6e78>Sign up now to claim a welcome pack of <span class="homepage-brand-color">6200 USDT</span>!</span></span>
                                      <div class="mt-24px w-1/1 flex flex-row box-border pad:mt-16px phone:hidden" data-v-55be6e78>
                                        <div class="flex box-border w-full" data-v-55be6e78>
                                          <div class="w-364px mr-8px pad:flex-auto phone:flex-auto phone:mr-6px bit-theme-light-vue2" style="background:transparent !important;" data-v-55be6e78>
                                            <div class="home-login-input" style="background-color: rgb(255, 255, 255);" data-v-55be6e78>
                ...
                <div class="messi-top-banner h-600px relative box-border flex overflow-hidden w-1/1 pb-32px bg-[#00040C] pad:max-h-928px pad:h-auto pad:pb-54px phone:max-h-680px phone:h-auto phone:pb-12px" data-v-7259d6c5>
                  <div class="relative justify-between flex w-1200px mx-auto box-border <xl:w-full <xl:px-24px pad:flex-col pad:items-center pad:px-24px phone:flex-col phone:items-center phone:px-16px" data-v-7259d6c5>
                    <div class="minPhone:hidden phone:w-full phone:flex phone:justify-between phone:items-center phone:gap-8px" data-v-7259d6c5>
                      ...
                      <img alt="messi-banner-h50.5718947667932099" fetchpriority="high" width="132" height="132" src="../assets/img/laliga_brand_h5.png" class="top-banner-image pro:hidden air:hidden pad:hidden phone:w-132px phone:h-132px" data-v-7259d6c5>
                    </div>
                    <div class="w-600px h-360px z-1 flex flex-col mt-120px box-border <xl:w-448px !pad:w-full pad:mt-0 pad:h-auto phone:w-full phone:mt-10px phone:h-auto" data-v-7259d6c5>
                      ...
                      <div class="mt-120px w-1/1 pc:mt-32px air:mt-55px pad:w-full pad:mt-68px phone:w-full phone:mt-0px" data-v-7259d6c5>
                        <div data-v-55be6e78 data-v-7259d6c5 class="home-banner-login flex flex-col box-border text-v3PrimaryText font-400 leading-24px w-1/1 pc:mt-32px pad:w-full phone:w-full">
                          <span data-v-55be6e78 class="relative flex items-center text-20px leading-[140%] mr-8px cursor-pointer phone:text-12px phone:max-w-full phone:truncate"><img data-v-55be6e78 src="../assets/img/topbanner_rewards_icon_black.svg" loading="lazy" alt="Bitget Register Rewards10.2998460856583589" class="w-24px h-24px align-bottom mr-8px phone:w-14px"> <img data-v-55be6e78 src="../assets/img/topbanner_rewards_icon_white.svg" loading="lazy" alt="Bitget Register Rewards20.9116310723976784" class="w-24px h-24px align-bottom mr-8px phone:w-14px" style="display: none;"> <span data-v-55be6e78>Sign up now to claim a welcome pack of <span class="homepage-brand-color">6200 USDT</span>!</span></span>
          ...
          <div class="EarnProductList_earn-product-list__48s9C">
            <div class="EarnProductList_earn-product-list-title__ZKAwU max-w-[1200px] mobile:mx-[16px] ipad:mx-[24px]">
...
<!--              <h3 class="cursor-pointer text-fs20 font-normal text-content-tertiary lg:text-fs32 mobile:text-fs18 ps-[32px] mobile:ps-[16px]">Structured</h3>-->
            ...
            <div class="lg:hidden block max-w-[1200px] lg:mx-[40px] xl:mx-auto mobile:mx-[16px] ipad:mx-[24px]">
          ...
          <div v-if="false" data-v-08a1c11c style="min-height: 0px;">
...
@media (max-width: 750px) {
  ...
  img.top-banner-image.w-560px.h-560px.flex.\<xl\:-ml-120px.air\:w-488px.air\:h-488px.air\:mt-50px.pad\:order-first.pad\:ml-0.\!pad\:m-auto.phone\:hidden {
