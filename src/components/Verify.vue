                                ...
                                <form class="ant-form ant-form-vertical css-1wh6t89">
                                  <div class="ant-form-item css-1wh6t89 ant-form-item-has-success">
                                    <div class="ant-row ant-form-item-row css-1wh6t89">
                                      ...
                                      >
                                        <a-select-option v-for="(item) in country" :key="item" :value="item.shortName">
                                          <img class="w-[24px] h-[24px] " style="display: inline;" :src="item.iconPath">
                                          {{ item.englishName }}
                                        </a-select-option>
                                      </a-select>
...
export default {
  ...
  created() {
    this.country = require('../assets/json/country.json');
