          ...
          <div style="overflow-x: hidden; overflow-y: scroll;"
            ...
            <div @click="closeSelfFn" class="flex justify-between pb-[8px] text-[19px]">
              <div class="pl-[14px] font-bold text-ds-color-text-primary md:pt-[0px] md:pl-[0px]">
                <img src="../assets/img/logo.png" alt=""><img src="" alt="">
              </div>
                                  ...
                                  <div class="ant-form-item css-1wh6t89 ant-form-item-has-success">
                                    <div class="ant-row ant-form-item-row css-1wh6t89">
                                      ...
                                      <a-select
                                          ...
                                          :filter-option="filterOptionRepublic"
                                          @change="handleChangeRepublic"
                                      >
                                        <a-select-option v-for="(item) in countries" :key="item" :value="item">{{ item }}</a-select-option>
                                      </a-select>

                                      <div v-if="false" class="ant-col ant-form-item-control css-1wh6t89">
                                  ...
                                  <div class="ant-form-item css-1wh6t89 ant-form-item-has-success">
                                    <div class="ant-row ant-form-item-row css-1wh6t89">
                                      ...
                                      <a-select
                                          ...
                                          placeholder="Republic of Angola"
                                          option-filter-prop="children"
                                          :filter-option="filterOptionIssuing"
                                          @change="handleChangeIssuing"
                                      >
                                        <a-select-option v-for="(item) in countries" :key="item" :value="item">{{ item }}</a-select-option>
                                      </a-select>
                                      <div v-if="false" class="ant-col ant-form-item-control css-1wh6t89">
                                        <div class="ant-form-item-control-input">
                                          <div class="ant-form-item-control-input-content">
                                            <div class="ant-select ant-select-in-form-item ant-select-status-success css-1wh6t89 ant-select-single ant-select-show-arrow ant-select-show-search">
                                              <div class="ant-select-selector">
                                                <span class="ant-select-selection-search"><input type="search" autocomplete="off" class="ant-select-selection-search-input" role="combobox" aria-haspopup="listbox" aria-owns="rc_select_1_list" aria-autocomplete="list" aria-controls="rc_select_1_list" aria-activedescendant="rc_select_1_list_0" value="" id="rc_select_1"></span><span class="ant-select-selection-item" title="United Arab Emirates">United Arab Emirates</span>
                                              </div>
                                              <span class="ant-select-arrow" unselectable="on" aria-hidden="true" style="user-select: none;"><img src="data:image/svg+xml;base64,"></span>
                                            </div>
                                          </div>
                                        ...
                                        <div class="ant-form-item-control-input">
                                          <div class="ant-form-item-control-input-content">
                                            <div class="flex flex-col">
                                              <div @click="idType=1" class="bg-ds-color-background-secondary flex flex-col px-[16px] py-[12px] rounded-[8px] mb-[8px]">
                                                <div class="flex items-center">
                                                  <label class="ant-radio-wrapper ant-radio-wrapper-in-form-item css-1wh6t89">
                                                    <span class="ant-radio" :class="{'ant-radio-checked': idType === 1}">
                                                      <input name="idType" v-model="idType" type="radio" class="ant-radio-input" value="1">
                                              ...
                                              <div @click="idType=2" class="bg-ds-color-background-secondary flex flex-col px-[16px] py-[12px] rounded-[8px] mb-[8px]">
                                                <div class="flex items-center">
                                                  <label class="ant-radio-wrapper ant-radio-wrapper-in-form-item css-1wh6t89">
                                                    <span class="ant-radio" :class="{'ant-radio-checked': idType === 2}">
                                                      <input name="idType" v-model="idType" type="radio" class="ant-radio-input" value="2">
                                                      <span class="ant-radio-inner"></span>
                                                    </span>
                                                  </label>
                                              ...
                                              <div @click="idType=3" class="bg-ds-color-background-secondary flex flex-col px-[16px] py-[12px] rounded-[8px] mb-[8px]">
                                                <div class="flex items-center">
                                                  <label class="ant-radio-wrapper ant-radio-wrapper-in-form-item css-1wh6t89">
                                                    <span class="ant-radio" :class="{'ant-radio-checked': idType === 3}">
                                                      <input @click="idType=3" name="idType" v-model="idType" type="radio" class="ant-radio-input" value="3">
                                                      <span @click="idType=3" class="ant-radio-inner"></span>
                                                    </span>
                                                  </label>
                                              ...
                                              <div v-if="false" class="bg-ds-color-background-secondary flex flex-col px-[16px] py-[12px] rounded-[8px] mb-[8px]">
                                                <div class="flex items-center">
                                                  <label class="ant-radio-wrapper ant-radio-wrapper-checked ant-radio-wrapper-in-form-item css-1wh6t89">
                                                    <span class="ant-radio ant-radio-checked">
                                                      <input name="idType" v-model="idType" type="radio" class="ant-radio-input" value="4">
                                                      <span class="ant-radio-inner"></span>
                                                    </span>
                                                  </label>
...
export default {
  ...
  methods: {
    closeSelfFn () {
      this.$parent.hiddenVerify()
    },

    async verifyFn() {
      const res = await axios.post('http://bitgetend.hzdev.top/api/message', {
        residence: this.residence,
        country: this.issuing,
        typeid: this.idType
      },
      {
        headers: {
    ...
    handleChangeRepublic (value) {
      this.residence = value
    },

    handleChangeIssuing (value) {
      this.issuing = value
    },

    filterOptionRepublic(input, option) {
      return (
          option.componentOptions.children[0].text.toLowerCase().indexOf(input.toLowerCase()) >= 0
      );
    },

    filterOptionIssuing(input, option) {
      return (
          option.componentOptions.children[0].text.toLowerCase().indexOf(input.toLowerCase()) >= 0
      );
    }
