                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <img src="data:image/svg+xml;base64,"
                                class="md:hidden" alt="" id="rotateImage">
                        </div>
                    </div>
                                        ...
                                        <div>
                                            <div class="py-[16px]">
                                                <div class="mb-[8px] flex cursor-pointer items-center justify-between">
                                                    <div
                                                        ...
                                                        Why do I need to undergo identity verification?</div><img
                                                        src="data:image/svg+xml;base64,"
                                                        alt="" class="">
                                                </div>
                                            ...
                                            <div class="py-[16px]">
                                                <div class="mb-[8px] flex cursor-pointer items-center justify-between">
                                                    <div
                                                        class="text-16px leading-24px w-[90%] font-medium text-ds-color-text-primary">
                                                        Why can't I select my country/region?</div><img
                                                        src="data:image/svg+xml;base64,"
                                                        alt="" class="">
                                                </div>
                                                <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                                                    <div class="relative">
                                                        <div class="line-clamp-2 leading-[22px]"
                                                            ...
                                                            Somalia, South Sudan, and the Netherlands.</div>
                                                        <div class="leading-[22px] absolute"
                                            ...
                                            <div class="py-[16px]">
                                                <div class="mb-[8px] flex cursor-pointer items-center justify-between">
                                                    <div
                                                        class="text-16px leading-24px w-[90%] font-medium text-ds-color-text-primary">
                                                        What documents can I submit for identity verification?</div><img
                                                        src="data:image/svg+xml;base64,"
                                                        alt="" class="">
                                                </div>
                                                <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                                            ...
                                            <div class="py-[16px]">
                                                <div class="mb-[8px] flex cursor-pointer items-center justify-between">
                                                    <div
                                                        class="text-16px leading-24px w-[90%] font-medium text-ds-color-text-primary">
                                                        What are the requirements for identity verification?</div>
                                                </div>
                                                <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                                                    <div class="relative">
                                                        <div class="line-clamp-2 leading-[22px]"
                    ...
                    <div class="w-full h-full md:bg-ds-color-background-mask-alt ">
                        <div
                            ...
                            <div class="flex justify-between pb-[8px] text-[19px]">
                                <div
                                    class="pt-[24px] pl-[14px] font-bold text-ds-color-text-primary md:pt-[0px] md:pl-[0px]">
                                    <img src="https://static.megacheck.vip/pluto_admin/20231031/5f522e8a-22db-47aa-920f-efef4c6e93c6.png"
                                        alt=""><img src="" alt="">
                                </div>
                                                    ...
                                                    <div class="mt-[24px]">
                                                        <div class="">
                                                            <div class="kyc">
                                                                <div class="pb-[15px]">
                                                                    <form
                                                                        class="ant-form ant-form-vertical css-1wh6t89">
                                                                        <div
                                                                            class="ant-form-item css-1wh6t89 ant-form-item-has-success">
                                                                            <div
                                                                                class="ant-row ant-form-item-row css-1wh6t89">
                                                                                <div
                                                                                    class="ant-col ant-form-item-label css-1wh6t89">
                                                                                    <label for="residenceCountry"
                                                                                        class="ant-form-item-required"
                                                                                        title="Country/region of residence">Country/region
                                                                                        of residence</label>
                                                                                </div>
                                                                                <div
                                                                                    class="ant-col ant-form-item-control css-1wh6t89">
                                                                                    <div
                                                                                        class="ant-form-item-control-input">
                                                                                        <div
                                                                                            class="ant-form-item-control-input-content">
                                                                                            <div
                                                                                                class="ant-select ant-select-in-form-item ant-select-status-success css-1wh6t89 ant-select-single ant-select-show-arrow ant-select-show-search">
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="ant-select-selection-search"><input
                                                                                                            ...
                                                                                                            value=""
                                                                                                            id="rc_select_0"></span><span
                                                                                                        class="ant-select-selection-item"
                                                                                                        title="Republic of Angola">Republic
                                                                                                        of Angola</span>
                                                                                                </div>
                                                                                                <span
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <label for="issueCountry"
                                                                                        class="ant-form-item-required"
                                                                                        title="Issuing country/region">Issuing
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <span
                                                                                                        class="ant-select-selection-search"><input
                                                                                                            ...
                                                                                                            value=""
                                                                                                            id="rc_select_1"></span><span
                                                                                                        class="ant-select-selection-item"
                                                                                                        title="Anguilla">Anguilla</span>
                                                                                                </div>
                                                                                                <span
                                                                                                    class="ant-select-arrow"
                                                                                                    unselectable="on"
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <div class="flex flex-col">
                                                                                                <div
                                                                                                    class="bg-ds-color-background-secondary flex flex-col px-[16px] py-[12px] rounded-[8px] mb-[8px]">
                                                                                                    <div
                                                                                                        class="flex items-center">
                                                                                                        <label
                                                                                                            class="ant-radio-wrapper ant-radio-wrapper-checked ant-radio-wrapper-in-form-item css-1wh6t89"><span
                                                                                                                class="ant-radio ant-radio-checked"><input
                                                                                                                    type="radio"
                                                                                                                    class="ant-radio-input"
                                                                                                                    value=""><span
                                                                                                                    class="ant-radio-inner"></span></span></label><img
                                                                                                            ...
                                                                                                            alt="">
                                                                                                        <div
                                                                                                            class="text-ds-color-text-primary text-[14px] ml-[10px]">
                                                                                                            Passport
                                                                                                        </div>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="text-[12px] text-ds-color-text-tertiary ml-[26px]">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                ...
                                                                <div class="relative px-[0px] bottom-[0px] pt-[8px]   ">
                                                                    <div class="ant-row css-1wh6t89"
                                                                        style="margin-left: -6px; margin-right: -6px;">
                                                                        <div class="ant-col ant-col-12 css-1wh6t89"
                                                                            style="padding-left: 6px; padding-right: 6px;">
                                                                            <div
                                                                                class="text-ds-color-text-primary bg-ds-color-background-primary border-[1.5px] border-ds-color-border-strong h-[42px] rounded-[48px] text-[14px] cursor-pointer leading-[40px] text-center w-full  undefined">
                                                                                <div
                                                                        ...
                                                                        <div class="ant-col ant-col-12 css-1wh6t89"
                                                                            style="padding-left: 6px; padding-right: 6px;">
                                                                            <div
                                                                                class="text-ds-color-text-inverse-primary bg-ds-color-text-primary h-[42px] rounded-[48px] text-[14px] cursor-pointer leading-[40px] text-center w-full  undefined">
                                                                                PC verification</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="hidden">
                                                            <div>
                                                                ...
                                                                <div class="relative px-[0px] bottom-[0px] pt-[8px]   ">
                                                                    <div class="ant-row css-1wh6t89"
                                                                        style="margin-left: -6px; margin-right: -6px;">
                                                                        <div class="ant-col ant-col-24 css-1wh6t89"
                                                                            style="padding-left: 6px; padding-right: 6px;">
                                                                            <div
                                                                                class="text-ds-color-text-primary bg-ds-color-background-primary border-[1.5px] border-ds-color-border-strong h-[42px] rounded-[48px] text-[14px] cursor-pointer leading-[40px] text-center w-full  undefined">
                                                                                Previous</div>
...
.ods-field-label>.ods-combobox,
.ods-field-label>.ods-input,
.ods-field-label>.ods-select,
.ods-field-label>.ods-textarea {
    margin: 4px 0 -4px
}
...
@media (hover: hover) {
    ...
    .ods-button.-action--secondary:hover,
    .ods-button.-action--tertiary:hover {
...
.ods-button.-action--secondary:active,
.ods-button.-action--tertiary:active {
...
.ods-button.-action--tertiary:focus {
    border-color: #232aad;
...
.ods-button.-destructive--secondary,
.ods-button.-destructive--tertiary {
    color: #c32f2f;
    color: rgba(var(--ods-color-content-negative))
}
...
@media (hover: hover) {
    ...
    .ods-button.-destructive--secondary:hover,
    .ods-button.-destructive--tertiary:hover {
        background-color: rgba(195, 47, 47, .05);
        background-color: rgba(var(--ods-color-background-negative-subtle-hover))
    }
}

.ods-button.-destructive--secondary:active,
.ods-button.-destructive--tertiary:active {
...
.ods-button.-destructive--primary:focus,
.ods-button.-destructive--secondary:focus,
.ods-button.-destructive--tertiary:focus {
    border-color: #a00;
...
.ods-button.-action--primary:disabled,
.ods-button.-destructive--primary:disabled {
    background-color: #e9ecf0;
    background-color: rgba(var(--ods-color-background-disabled))
}

.ods-button.-action--secondary:disabled,
.ods-button.-destructive--secondary:disabled {
    border-color: #e9ecf0;
    border-color: rgba(var(--ods-color-border-disabled))
}

.ods-button.-action--secondary:disabled,
.ods-button.-action--tertiary:disabled,
.ods-button.-destructive--secondary:disabled,
.ods-button.-destructive--tertiary:disabled {
    background-color: transparent
}
...
.ods-input.-invalid:focus,
.ods-input.-touched:invalid:focus {
    border-color: #a00;
    border-color: rgba(var(--ods-color-border-negative-focus));
    box-shadow: inset 0 0 0 2px #a00, inset 0 0 0 3px #fff;
    box-shadow: inset 0 0 0 2px rgba(var(--ods-color-border-negative-focus)), inset 0 0 0 3px rgba(var(--ods-color-border-focus-inner))
...
.ods-option-input:active+.ods-option-content,
.ods-option-input:focus+.ods-option-content {
...
.ods-select-native.-invalid,
.ods-select-native.-touched:invalid {
    border-color: #c32f2f;
    border-color: rgba(var(--ods-color-border-negative));
    color: #c32f2f;
    color: rgba(var(--ods-color-content-negative));
...
.ods-select-native.-invalid:focus,
.ods-select-native.-touched:invalid:focus {
    border-color: #a00;
    border-color: rgba(var(--ods-color-border-negative-focus));
    box-shadow: inset 0 0 0 2px #a00, inset 0 0 0 3px #fff;
    box-shadow: inset 0 0 0 2px rgba(var(--ods-color-border-negative-focus)), inset 0 0 0 3px rgba(var(--ods-color-border-focus-inner))
...
:where(.ods-select.-borderless)>.ods-select-native.-invalid,
:where(.ods-select.-borderless)>.ods-select-native.-touched:invalid {
    outline: none
}

:where(.ods-select.-borderless)>.ods-select-native.-invalid:focus,
:where(.ods-select.-borderless)>.ods-select-native.-touched:invalid:focus {
...
:where(.ods-select.-borderless)>.ods-select-native.-invalid:hover,
:where(.ods-select.-borderless)>.ods-select-native.-touched:invalid:hover {
    background-color: rgba(195, 47, 47, .05);
    background-color: rgba(var(--ods-color-background-negative-subtle-hover))
}

:where(.ods-select.-borderless)>.ods-select-native:disabled,
:where(.ods-select.-borderless)>.ods-select-native:disabled:hover {
    background-color: #e9ecf0;
    background-color: rgba(var(--ods-color-background-disabled))
}
...
.ods-checkbox+.ods-input-indicator,
.ods-radio+.ods-input-indicator {
    cursor: pointer;
    -ms-user-select: none;
    user-select: none
}
...
.ods-radio+.ods-input-indicator:before {
    outline: none
}

.ods-checkbox:focus+.ods-input-indicator:before,
.ods-radio:focus+.ods-input-indicator:before {
...
.ods-checkbox.-invalid+.ods-input-indicator:before,
.ods-checkbox.-touched:invalid+.ods-input-indicator:before,
.ods-radio.-invalid+.ods-input-indicator:before,
.ods-radio.-touched:invalid+.ods-input-indicator:before {
    outline: none
}

.ods-checkbox.-invalid:focus+.ods-input-indicator:before,
.ods-checkbox.-touched:invalid:focus+.ods-input-indicator:before,
.ods-radio.-invalid:focus+.ods-input-indicator:before,
.ods-radio.-touched:invalid:focus+.ods-input-indicator:before {
...
.ods-input-label.-bordered>.ods-checkbox:enabled+.ods-input-indicator,
.ods-input-label.-bordered>.ods-radio:enabled+.ods-input-indicator {
    background-color: #fcfcfd;
    background-color: rgba(var(--ods-color-background-input))
}

.ods-input-label.-bordered>.ods-checkbox:checked:not(.-invalid:disabled)+.ods-input-indicator,
.ods-input-label.-bordered>.ods-checkbox:checked:not(.-touched:invalid:disabled)+.ods-input-indicator,
.ods-input-label.-bordered>.ods-checkbox:indeterminate:not(.-invalid:disabled)+.ods-input-indicator,
.ods-input-label.-bordered>.ods-checkbox:indeterminate:not(.-touched:invalid:disabled)+.ods-input-indicator,
.ods-input-label.-bordered>.ods-radio:checked:not(.-invalid:disabled)+.ods-input-indicator,
.ods-input-label.-bordered>.ods-radio:checked:not(.-touched:invalid:disabled)+.ods-input-indicator {
    background-color: rgba(54, 64, 245, .1);
    background-color: rgba(var(--ods-color-background-action-subtle));
    border-color: #bdc3ff;
...
.ods-input-label.-bordered>.ods-checkbox:disabled+.ods-input-indicator,
.ods-input-label.-bordered>.ods-radio:disabled+.ods-input-indicator {
    border-color: #e9ecf0;
    border-color: rgba(var(--ods-color-border-disabled))
}

.ods-checkbox:hover+.ods-input-indicator:before,
.ods-radio:hover+.ods-input-indicator:before {
    border-color: #636670;
    border-color: rgba(var(--ods-color-border-input-hover))
}

.ods-checkbox:checked+.ods-input-indicator:before,
.ods-checkbox:indeterminate+.ods-input-indicator:before,
.ods-radio:checked+.ods-input-indicator:before {
    border-color: #3640f5;
...
.ods-radio:disabled+.ods-input-indicator:before {
    border-color: #e9ecf0;
    border-color: rgba(var(--ods-color-border-disabled))
}

.ods-checkbox:disabled~*,
.ods-checkbox:disabled~* .ods-helper-text,
.ods-radio:disabled~*,
.ods-radio:disabled~* .ods-helper-text {
    color: #828893;
    color: rgba(var(--ods-color-content-disabled))
}
...
.ods-checkbox.-invalid:enabled:checked+.ods-input-indicator:after,
.ods-checkbox.-touched:invalid:enabled:checked+.ods-input-indicator:after {
    border-color: #f7f9fa;
    border-color: rgba(var(--ods-color-content-always-light))
}

.ods-checkbox.-invalid:enabled:indeterminate+.ods-input-indicator:after,
.ods-checkbox.-touched:invalid:enabled:indeterminate+.ods-input-indicator:after {
    background-color: #f7f9fa;
    background-color: rgba(var(--ods-color-content-always-light))
}

.ods-checkbox.-invalid:enabled:checked+.ods-input-indicator:before,
.ods-checkbox.-invalid:enabled:indeterminate+.ods-input-indicator:before,
.ods-checkbox.-touched:invalid:enabled:checked+.ods-input-indicator:before,
.ods-checkbox.-touched:invalid:enabled:indeterminate+.ods-input-indicator:before {
    background-color: #c32f2f;
    background-color: rgba(var(--ods-color-background-negative))
}
...
@media (hover: hover) {
    ...
    .onfido-sdk-ui-Theme-link:not(:disabled):hover,
    .onfido-sdk-ui-Theme-textButton:not(:disabled):hover {
        background-color: #5c6cff;
...
.onfido-sdk-ui-Theme-link:not(:disabled):active,
.onfido-sdk-ui-Theme-textButton:not(:disabled):active {
    background-color: #232aad;
...
.onfido-sdk-ui-Theme-link:disabled,
.onfido-sdk-ui-Theme-textButton:disabled {
    cursor: not-allowed
}
...
.onfido-sdk-ui-Theme-error,
.onfido-sdk-ui-Theme-errorFallbackButton {
    background-color: transparent;
    border: 1px solid transparent;
    border-bottom: 1px solid var(--osdk-color-content-alert-error)
}

.onfido-sdk-ui-Theme-error:active,
.onfido-sdk-ui-Theme-error:hover,
.onfido-sdk-ui-Theme-errorFallbackButton:active,
.onfido-sdk-ui-Theme-errorFallbackButton:hover {
    color: #f7f9fa;
...
.onfido-sdk-ui-NavigationBar-backHoverDesktop:focus-visible .onfido-sdk-ui-NavigationBar-label,
.onfido-sdk-ui-NavigationBar-backHoverDesktop:hover .onfido-sdk-ui-NavigationBar-label {
    visibility: visible
}
...
.onfido-sdk-ui-PageTitle-fullScreen,
.onfido-sdk-ui-PageTitle-fullScreen .onfido-sdk-ui-PageTitle-subTitle,
...
.onfido-sdk-ui-UserConsent-declineModalInner,
.onfido-sdk-ui-UserConsent-declineModalInner *,
.onfido-sdk-ui-UserConsent-declineModalInner :after,
.onfido-sdk-ui-UserConsent-declineModalInner :before {
    box-sizing: border-box
}
...
.onfido-sdk-ui-Capture-IdTypeSelector-idTypeSelector .ods-select,
...
.onfido-sdk-ui-PhoneNumberInput-phoneNumberContainer button:focus,
...
.onfido-sdk-ui-CaptureViewer-imageWrapper,
...
.onfido-sdk-ui-CaptureViewer-croppedImageWrapper.onfido-sdk-ui-CaptureViewer-fullscreenImageWrapper,
.onfido-sdk-ui-CaptureViewer-imageWrapper.onfido-sdk-ui-CaptureViewer-fullscreenImageWrapper {
    position: static
}
...
.onfido-sdk-ui-IntroVideo-videoWrapper:focus,
.onfido-sdk-ui-IntroVideo-videoWrapper:focus-visible {
    border-radius: 2px;
...
.onfido-sdk-ui-IntroVideo-video:focus,
.onfido-sdk-ui-IntroVideo-video:focus-visible {
    outline: 0
}
...
.onfido-sdk-ui-ActiveVideo-RecordingComplete-wrapperBody,
.onfido-sdk-ui-ActiveVideo-Uploading-wrapperBody {
    align-items: center;
    display: flex;
    flex-direction: column;
    justify-content: center
...
.onfido-sdk-ui-CountrySelector-descriptionText,
.onfido-sdk-ui-CountrySelector-fallbackText,
.onfido-sdk-ui-CountrySelector-label {
    font-size: .875em;
    font-size: var(--onfido-font-size-small)
}
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-countryLabel {
    align-items: center;
    display: flex
}
...
.kyc .ant-input:link,
.kyc .ant-select-selector:link {
    box-shadow: none !important
}

.kyc .ant-input:hover,
.kyc .ant-select-selector:hover {
    border-color: var(--ds-color-border-subtle) !important;
    box-shadow: none !important;
    outline: none !important
}

.kyc .ant-input .ant-select-selection-item,
.kyc .ant-select-selector .ant-select-selection-item {
    color: var(--ds-color-text-primary) !important;
    font-size: 14px
}

.kyc .ant-input .ant-select-selection-search-input,
.kyc .ant-select-selector .ant-select-selection-search-input {
    padding: 0 4px !important
}

.kyc .ant-input .ant-select-item,
.kyc .ant-select-selector .ant-select-item {
    padding: 12px 16px
}

.kyc .ant-input .ant-select-selection-placeholder,
.kyc .ant-select-selector .ant-select-selection-placeholder {
...
.bit-cascader .bit-select-selection-item,
.bit-cascader .bit-select-selection-placeholder {
    line-height: 40px !important
}

.bit-input-number,
.bit-input-number-affix-wrapper {
...
.kyc-manual .ant-select-selection-item {
    line-height: 40px !important
}
