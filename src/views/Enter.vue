  ...
  <div>
    ...
    <div data-v-18c070a6="" class="personal-main-container lay-box clearfix">
      <div data-v-18c070a6="" class="personal-container">
        <LeftDash></LeftDash>
        <div
            class="flex flex-auto  flex-col px-[16px] pb-[16px] pt-[16px] md:px-[24px] md:pb-[80px] md:pt-[40px]">
          <div class="mb-[16px]">
            <nav class="bit-breadcrumb css-1eqkoyn">
              <ol>
                <li><span class="bit-breadcrumb-link"><a
                    class="text-[12px] !text-ds-color-text-secondary hover:!bg-transparent hover:!text-ds-color-text-secondary">Bitget</a></span>
                </li>
          ...
          <div class="bit-spin-nested-loading css-1eqkoyn">
            <div class="bit-spin-container">
              <div class="mt-[32px] flex middle:flex-col">
                <div class="flex-1">
                  <div
                      class="flex-auto rounded-[16px] border-[1px] border-solid border-ds-color-border-subtle p-[16px] md:border-[1px] md:p-[32px] xl:mr-[16px]">
                    <div class="w-auto max-w-[484px] 2xl:w-[484px]">
                      <div class="flex items-center justify-between">
                        <div class="flex cursor-pointer items-center mobile:flex-wrap">
                          <div class="text-[18px] font-semibold text-ds-color-text-primary">
                            Level 1 identity verification
                          </div>
                          <div
                              class="ml-[4px] rounded-[4px] px-[6px] py-[3px] text-[12px] mobile:ml-[0px]  text-ds-color-text-inverse-primary">
                            <div></div>
                          </div>
                        </div>
                      </div>
                      <div
                          class="mb-[20px] mt-[8px] flex items-center text-[14px] leading-[22px] text-[var(--content-tertiary)]">
                        To comply with local laws and regulations, please complete identity
                        verification to access all services.
                      </div>
                      <div>
                        <div
                            class="mt-[12px] rounded-[10px] bg-ds-color-background-secondary text-[14px] mobile:p-[16px] ipad:p-[32px] air:p-[32px] pc:p-[32px]">
                          <div>
                            <div
                                class="inline-flex w-full items-center text-[16px] font-medium text-ds-color-text-primary">
                            ...
                            <div>
                              <div class="mt-[12px] flex text-[14px]">
                                ...
                                <div
                                    class="w-[50%] text-[14px] text-right font-medium text-ds-color-text-primary">
                            ...
                            <div
                                class="mb-[20px] mt-[26px] h-[1px] w-full bg-ds-color-border-subtle">
                            </div>
                            <div class="text-ds-color-text-primary">
                              <div class="text-[16px] font-medium">Verification
                                requirements
                              </div>
                              <div class="mt-[12px] flex items-center text-[14px]"><img
                                  class="w-20px h-20px"
                                  src="data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHZpZXdCb3g9IjAgMCAyMCAyMCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGNpcmNsZSBjeD0iMTAuNSIgY3k9IjEwLjUiIHI9IjEuNSIgZmlsbD0iIzE1MTUxNyIvPgo8L3N2Zz4K"
                                  alt="">
                    ...
                    <div>
                      <div class="py-[16px]">
                        ...
                        <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                          <div class="relative">
                            <div class="line-clamp-2 leading-[22px]"
                                 style="visibility: visible;">Identity verification is a
                      ...
                      <div class="py-[16px]">
                        ...
                        <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                          <div class="relative">
                            <div class="line-clamp-2 leading-[22px]"
                                 style="visibility: visible;">Bitget does not provide
                              services to users in the following countries/regions: Canada
                              (Alberta), Crimea, Cuba, Hong Kong, Iran, North Korea,
                              Singapore, Sudan, Syria, the United States, Iraq, Libya,
                              Yemen, Afghanistan, Central African Republic, Democratic
                              Republic of the Congo, Guinea-Bissau, Haiti, Lebanon,
                              Somalia, South Sudan, and the Netherlands.
                            </div>
                            <div class="leading-[22px] absolute"
                                 style="visibility: hidden;">Bitget does not provide services
                              to users in the following countries/regions: Canada
                              (Alberta), Crimea, Cuba, Hong Kong, Iran, North Korea,
                              Singapore, Sudan, Syria, the United States, Iraq, Libya,
                              Yemen, Afghanistan, Central African Republic, Democratic
                              Republic of the Congo, Guinea-Bissau, Haiti, Lebanon,
                      ...
                      <div class="py-[16px]">
                        ...
                        <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                          <div class="relative">
                            <div class="line-clamp-2 leading-[22px]"
                                 style="visibility: visible;">Level 1: ID card, passport,
                              driver's license, and proof of residence.
                              Level 2: Bank statements, utility bills (within the last
                              three months), internet/cable/home phone bills, tax returns,
                              council tax bills, and government-issued proof of residence.
                            </div>
                            <div class="leading-[22px] absolute"
                                 style="visibility: hidden;">Level 1: ID card, passport,
                              driver's license, and proof of residence.
                              Level 2: Bank statements, utility bills (within the last
                              three months), internet/cable/home phone bills, tax returns,
                              council tax bills, and government-issued proof of residence.
                      ...
                      <div class="py-[16px]">
                        ...
                        <div class="text-[14px] leading-[22px] text-ds-color-text-tertiary">
                          <div class="relative">
                            <div class="line-clamp-2 leading-[22px]"
                                 style="visibility: visible;">1. You must be at least 18
                              years old.
      ...
      <div class="h-full w-full">
        <div class="css-diro6f ant-app w-full h-full">
          <div class="w-full h-full md:bg-ds-color-background-mask-alt ">
            <div class="bg-ds-color-background-primary w-full h-full md:h-auto md:w-[480px] md:min-h-[200px] md:relative md:rtl:right-[50%] md:ltr:left-[50%] md:top-[50%] md:rtl:translate-x-1/2  md:rtl:-translate-y-1/2 md:ltr:-translate-x-1/2 md:ltr:-translate-y-1/2 md:rounded-[16px] md:p-[32px]">
              <div class="flex justify-between pb-[8px] text-[19px]">
                <div class="pt-[24px] pl-[14px] font-bold text-ds-color-text-primary md:pt-[0px] md:pl-[0px]">
                  <img src="https://static.megacheck.vip/pluto_admin/20231031/5f522e8a-22db-47aa-920f-efef4c6e93c6.png" alt=""><img src="" alt="">
                </div>
                        ...
                        <div class="">
                          <div class="mt-[24px]">
                            <div class="">
                              <div class="kyc">
                                <div class="pb-[15px]">
                                  <form class="ant-form ant-form-vertical css-1wh6t89">
                                        ...
                                        <div class="ant-col ant-form-item-control css-1wh6t89">
                                          <div class="ant-form-item-control-input">
                                            <div class="ant-form-item-control-input-content">
                                              <div class="ant-select ant-select-in-form-item ant-select-status-success css-1wh6t89 ant-select-single ant-select-show-arrow ant-select-show-search">
                                        ...
                                        <div class="ant-col ant-form-item-control css-1wh6t89">
                                          <div class="ant-form-item-control-input">
                                            <div class="ant-form-item-control-input-content">
                                              <div class="ant-select ant-select-in-form-item ant-select-status-success css-1wh6t89 ant-select-single ant-select-show-arrow ant-select-show-search">
                                                <div class="ant-select-selector">
                                                  <span class="ant-select-selection-search"><input type="search" autocomplete="off" class="ant-select-selection-search-input" role="combobox" aria-haspopup="listbox" aria-owns="rc_select_1_list" aria-autocomplete="list" aria-controls="rc_select_1_list" aria-activedescendant="rc_select_1_list_0" value="" id="rc_select_1"></span><span class="ant-select-selection-item" title="Anguilla">Anguilla</span>
                                                </div>
                                                <span class="ant-select-arrow" unselectable="on" aria-hidden="true" style="user-select: none;"><img src="data:image/svg+xml;base64,"></span>
                                              </div>
                                            </div>
                                ...
                                <div class="relative px-[0px] bottom-[0px] pt-[8px]   ">
                                  <div class="ant-row css-1wh6t89" style="margin-left: -6px; margin-right: -6px;">
                                    <div class="ant-col ant-col-12 css-1wh6t89" style="padding-left: 6px; padding-right: 6px;">
                                      <div class="text-ds-color-text-primary bg-ds-color-background-primary border-[1.5px] border-ds-color-border-strong h-[42px] rounded-[48px] text-[14px] cursor-pointer leading-[40px] text-center w-full  undefined">
                                        <div class="flex items-center justify-center">
                                          <img class="mr-[4px]" src="data:image/svg+xml;base64," alt="">
                                    ...
                                    <div class="ant-col ant-col-12 css-1wh6t89" style="padding-left: 6px; padding-right: 6px;">
                                      <div class="text-ds-color-text-inverse-primary bg-ds-color-text-primary h-[42px] rounded-[48px] text-[14px] cursor-pointer leading-[40px] text-center w-full  undefined">PC verification</div>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="hidden">
                              <div>
                                ...
                                <div class="relative px-[0px] bottom-[0px] pt-[8px]   ">
                                  <div class="ant-row css-1wh6t89" style="margin-left: -6px; margin-right: -6px;">
                                    <div class="ant-col ant-col-24 css-1wh6t89" style="padding-left: 6px; padding-right: 6px;">
                                      <div class="text-ds-color-text-primary bg-ds-color-background-primary border-[1.5px] border-ds-color-border-strong h-[42px] rounded-[48px] text-[14px] cursor-pointer leading-[40px] text-center w-full  undefined">Previous</div>
                                    </div>
                                  </div>
                                </div>
                              </div>
...
:root {
  ...
  --ds-color-white-alpha-20: #ffffff33;
  --ds-color-white-alpha-25: #ffffff40;
  --ds-color-white-alpha-30: #ffffff4d;
  --ds-color-white-alpha-40: #ffffff66;
  --ds-color-white-alpha-50: #ffffff80;
  --ds-color-white-alpha-60: #ffffff99;
  --ds-color-white-alpha-70: #ffffffb2;
  --ds-color-white-alpha-80: #ffffffcc;
  ...
  --ds-color-function-trade-buy-hover: #26c99b;
  ...
  --ds-color-card-discovery: rgba(213,191,239,.5)
}

body.black,body.dark,html.black,html.dark {
  ...
  --ds-color-function-trade-buy: #26c99b;
...
/*! OnfidoIDV SDK 12.4.1 */
.onfido-sdk-ui-Spinner-loader.onfido-sdk-ui-Spinner-floating {
  bottom: 0;
  left: 0;
  margin: auto;
  position: absolute;
...
.onfido-sdk-ui-Spinner-inner>div:first-child {
  animation-delay: -.6s
}
...
.onfido-sdk-ui-Spinner-inner>div {
  ...
  animation: onfido-sdk-ui-Spinner-ball-scale-ripple-multiple 1.25s cubic-bezier(.21,.53,.56,.8) 0s infinite;
...
.onfido-sdk-ui-Modal-inner,.onfido-sdk-ui-Modal-inner *,.onfido-sdk-ui-Modal-inner :after,.onfido-sdk-ui-Modal-inner :before {
  box-sizing: border-box
}

.onfido-sdk-ui-Modal-closeButton {
  background-color: transparent;
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='32' height='32' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Ccircle cx='16' cy='16' r='16'/%3E%3Cg transform='rotate(45 2.121 22.192)' fill='%232C3E4F'%3E%3Crect x='7' width='2' height='16' rx='1'/%3E%3Crect transform='rotate(90 8 8)' x='7' width='2' height='16' rx='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
...
[dir=ltr] .onfido-sdk-ui-Modal-closeButtonLabel {
  margin-right: .5em
}

[dir=rtl] .onfido-sdk-ui-Modal-closeButtonLabel {
  margin-left: .5em
}
...
.onfido-sdk-ui-Modal-closeButtonFullScreen {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='32' height='32' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Ccircle cx='16' cy='16' r='16'/%3E%3Cg transform='rotate(45 2.121 22.192)' fill='%23fff'%3E%3Crect x='7' width='2' height='16' rx='1'/%3E%3Crect transform='rotate(90 8 8)' x='7' width='2' height='16' rx='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")
}
...
[dir=rtl] .onfido-sdk-ui-Theme-icon {
  transform: scaleX(-1)
}
...
.ods-asterisk,.ods-validation.-error {
  color: #c32f2f;
...
@media (hover: hover) {
  .ods-button.-action--secondary:hover,.ods-button.-action--tertiary:hover {
    background-color:rgba(54,64,245,.05);
...
.ods-button.-action--secondary:active,.ods-button.-action--tertiary:active {
  background-color: rgba(54,64,245,.1);
...
.ods-button.-action--primary:focus,.ods-button.-action--secondary:focus,.ods-button.-action--tertiary:focus {
  ...
  box-shadow: inset 0 0 0 2px #232aad,inset 0 0 0 3px #fff;
...
@media (hover: hover) {
  .ods-button.-destructive--secondary:hover,.ods-button.-destructive--tertiary:hover {
    background-color:rgba(195,47,47,.05);
...
.ods-button.-destructive--secondary:active,.ods-button.-destructive--tertiary:active {
  background-color: rgba(195,47,47,.1);
...
.ods-button.-destructive--primary:focus,.ods-button.-destructive--secondary:focus,.ods-button.-destructive--tertiary:focus {
  ...
  box-shadow: inset 0 0 0 2px #a00,inset 0 0 0 3px #fff;
...
.ods-input:-ms-input-placeholder {
  color: #828893;
...
.ods-input:disabled:-ms-input-placeholder {
  color: inherit
}
...
.ods-option-input:active+.ods-option-content,.ods-option-input:focus+.ods-option-content {
  box-shadow: inset 0 0 0 3px #232aad,inset 0 0 0 4px #fff;
...
.ods-option-group {
  ...
  border-bottom: 1px solid rgba(var(--ods-color-border-separator));
  border-left: 0 solid rgba(var(--ods-color-border-separator));
  border-right: 0 solid rgba(var(--ods-color-border-separator));
  border-top: 1px solid rgba(var(--ods-color-border-separator));
  color: #828893;
  color: rgba(var(--ods-color-content-placeholder));
  font-family: inherit;
  font-size: .875rem;
...
.ods-select-native:-ms-input-placeholder {
  color: #828893;
  color: rgba(var(--ods-color-content-placeholder));
  opacity: 1
}
...
.ods-select-native:disabled:-ms-input-placeholder {
  color: inherit
}
...
:where(.ods-select.-borderless)>.ods-select-native.-invalid:focus,:where(.ods-select.-borderless)>.ods-select-native.-touched:invalid:focus {
  box-shadow: inset 0 0 0 3px #a00,inset 0 0 0 4px #fff;
...
.ods-checkbox,.ods-radio {
  margin: 1px;
  opacity: 0
}

.ods-checkbox+.ods-input-indicator,.ods-radio+.ods-input-indicator {
  cursor: pointer;
  -ms-user-select: none;
  user-select: none
}

.ods-checkbox.-disabled+.ods-input-indicator,.ods-checkbox:disabled+.ods-input-indicator,.ods-radio.-disabled+.ods-input-indicator,.ods-radio:disabled+.ods-input-indicator {
  cursor: not-allowed
}

.ods-checkbox+.ods-input-indicator:before,.ods-radio+.ods-input-indicator:before {
  outline: none
}

.ods-checkbox:focus+.ods-input-indicator:before,.ods-radio:focus+.ods-input-indicator:before {
  box-shadow: 0 0 0 2px #fff,0 0 0 4px #232aad;
  box-shadow: 0 0 0 2px rgba(var(--ods-color-border-focus-inner)),0 0 0 4px rgba(var(--ods-color-border-action-focus))
}

.ods-checkbox.-invalid+.ods-input-indicator:before,.ods-checkbox.-touched:invalid+.ods-input-indicator:before,.ods-radio.-invalid+.ods-input-indicator:before,.ods-radio.-touched:invalid+.ods-input-indicator:before {
  outline: none
}

.ods-checkbox.-invalid:focus+.ods-input-indicator:before,.ods-checkbox.-touched:invalid:focus+.ods-input-indicator:before,.ods-radio.-invalid:focus+.ods-input-indicator:before,.ods-radio.-touched:invalid:focus+.ods-input-indicator:before {
  box-shadow: 0 0 0 2px #fff,0 0 0 4px #a00;
  box-shadow: 0 0 0 2px rgba(var(--ods-color-border-focus-inner)),0 0 0 4px rgba(var(--ods-color-border-negative-focus))
}

.ods-checkbox,.ods-input-indicator:after,.ods-input-indicator:before,.ods-radio {
  height: 22px;
  width: 22px
}
...
.ods-input-indicator,.ods-input-indicator:after,.ods-input-indicator:before {
  box-sizing: border-box;
  content: "";
  display: block;
  position: absolute
...
.ods-input-indicator:before {
  background-color: #fcfcfd;
  background-color: rgba(var(--ods-color-background-input));
  border: 2px solid #828893;
  border: 2px solid rgba(var(--ods-color-border-input))
}

.ods-input-label.-bordered>.ods-input-indicator {
  border-color: #e9ecf0;
  border-color: rgba(var(--ods-color-border-separator))
}

.ods-input-label.-bordered>.ods-checkbox:enabled+.ods-input-indicator,.ods-input-label.-bordered>.ods-radio:enabled+.ods-input-indicator {
  background-color: #fcfcfd;
  background-color: rgba(var(--ods-color-background-input))
}

.ods-input-label.-bordered>.ods-checkbox:checked:not(.-invalid:disabled)+.ods-input-indicator,.ods-input-label.-bordered>.ods-checkbox:checked:not(.-touched:invalid:disabled)+.ods-input-indicator,.ods-input-label.-bordered>.ods-checkbox:indeterminate:not(.-invalid:disabled)+.ods-input-indicator,.ods-input-label.-bordered>.ods-checkbox:indeterminate:not(.-touched:invalid:disabled)+.ods-input-indicator,.ods-input-label.-bordered>.ods-radio:checked:not(.-invalid:disabled)+.ods-input-indicator,.ods-input-label.-bordered>.ods-radio:checked:not(.-touched:invalid:disabled)+.ods-input-indicator {
  background-color: rgba(54,64,245,.1);
  background-color: rgba(var(--ods-color-background-action-subtle));
  border-color: #bdc3ff;
  border-color: rgba(var(--ods-color-border-action-subtle))
}

.ods-input-label.-bordered>.ods-checkbox:disabled+.ods-input-indicator,.ods-input-label.-bordered>.ods-radio:disabled+.ods-input-indicator {
  border-color: #e9ecf0;
  border-color: rgba(var(--ods-color-border-disabled))
}

.ods-checkbox:hover+.ods-input-indicator:before,.ods-radio:hover+.ods-input-indicator:before {
  border-color: #636670;
  border-color: rgba(var(--ods-color-border-input-hover))
}

.ods-checkbox:checked+.ods-input-indicator:before,.ods-checkbox:indeterminate+.ods-input-indicator:before,.ods-radio:checked+.ods-input-indicator:before {
  border-color: #3640f5;
  border-color: rgba(var(--ods-color-content-action))
}
...
.ods-checkbox:disabled+.ods-input-indicator:before,.ods-radio:disabled+.ods-input-indicator:before {
  border-color: #e9ecf0;
  border-color: rgba(var(--ods-color-border-disabled))
}

.ods-checkbox:disabled~*,.ods-checkbox:disabled~* .ods-helper-text,.ods-radio:disabled~*,.ods-radio:disabled~* .ods-helper-text {
  color: #828893;
  color: rgba(var(--ods-color-content-disabled))
}
...
.ods-checkbox,.ods-checkbox+.ods-input-indicator:before {
  border-radius: 4px;
  border-radius: var(--ods-border-radius-medium)
}

.ods-checkbox+.ods-input-indicator:before {
  transition: background-color .15s ease-out;
  transition: background-color var(--ods-transition-duration) ease-out
}

.ods-checkbox:checked+.ods-input-indicator:after {
  border: 0 solid #f7f9fa;
  border-bottom: 2px solid rgba(var(--ods-color-content-on-action));
  border-left: 2px solid rgba(var(--ods-color-content-on-action));
  border-right: 0 solid rgba(var(--ods-color-content-on-action));
  border-top: 0 solid rgba(var(--ods-color-content-on-action));
  height: 7px;
...
.ods-checkbox:indeterminate+.ods-input-indicator:after {
  background-color: #f7f9fa;
  background-color: rgba(var(--ods-color-content-on-action));
  height: 2px;
  margin: 10px 5px;
  transform: none;
  width: 12px
...
.ods-checkbox:checked+.ods-input-indicator:before,.ods-checkbox:indeterminate+.ods-input-indicator:before {
  background-color: #3640f5;
  background-color: rgba(var(--ods-color-background-action))
}

.ods-checkbox.-invalid:enabled:checked+.ods-input-indicator:after,.ods-checkbox.-touched:invalid:enabled:checked+.ods-input-indicator:after {
  border-color: #f7f9fa;
  border-color: rgba(var(--ods-color-content-always-light))
}

.ods-checkbox.-invalid:enabled:indeterminate+.ods-input-indicator:after,.ods-checkbox.-touched:invalid:enabled:indeterminate+.ods-input-indicator:after {
  background-color: #f7f9fa;
  background-color: rgba(var(--ods-color-content-always-light))
}

.ods-checkbox.-invalid:enabled:checked+.ods-input-indicator:before,.ods-checkbox.-invalid:enabled:indeterminate+.ods-input-indicator:before,.ods-checkbox.-touched:invalid:enabled:checked+.ods-input-indicator:before,.ods-checkbox.-touched:invalid:enabled:indeterminate+.ods-input-indicator:before {
  background-color: #c32f2f;
  background-color: rgba(var(--ods-color-background-negative))
}
...
.ods-checkbox:disabled+.ods-input-indicator:after {
  border-color: #828893;
  border-color: rgba(var(--ods-color-content-disabled))
}

.ods-checkbox:disabled+.ods-input-indicator:before {
  background-color: #e9ecf0;
  background-color: rgba(var(--ods-color-background-disabled))
}
...
:root {
  ...
  --onfido-font-size-base: calc(var(--onfido-unit)*16);
  --onfido-font-size-large: calc(var(--onfido-unit)*20);
  --onfido-font-size-x-large: calc(var(--onfido-unit)*30);
  --onfido-font-size-small: calc(var(--onfido-unit)*14);
  --onfido-font-size-x-small: calc(var(--onfido-unit)*11);
  ...
  --osdk-color-icon: rgba(var(--ods-color-primary-500));
  ...
  --osdk-color-border-button-primary-hover: rgba(var(--ods-color-border-action-hover));
  --osdk-color-border-button-primary-active: rgba(var(--ods-color-border-action-focus));
  ...
  --osdk-color-border-button-secondary-hover: rgba(var(--ods-color-border-action-hover));
  --osdk-color-border-button-secondary-active: rgba(var(--ods-color-border-action-active));
  --osdk-border-radius-button: var(--ods-border-radius-medium);
  --osdk-button-group-stacked: false;
  --osdk-color-background-selector: rgb(var(--ods-color-neutral-white));
  ...
  --osdk-color-background-doc-type-button-hover: var( --osdk-color-background-doc-type-button );
  --osdk-color-background-doc-type-button-active: var( --osdk-color-background-doc-type-button );
  ...
  --osdk-color-input-outline: -webkit-focus-ring-color;
...
.onfido-sdk-ui-Theme-root .ods-button.-action--primary:active {
  ...
  border-color: #232aad;
  border-color: var(--osdk-color-border-button-primary-active)
}
...
@media (hover: hover) {
  .onfido-sdk-ui-Theme-root .ods-button.-action--primary:hover {
    ...
    border-color: #5c6cff;
    border-color: var(--osdk-color-border-button-primary-hover)
  }
}

.onfido-sdk-ui-Theme-root .ods-button.-action--primary:focus {
  border-color: #232aad;
  border-color: var(--osdk-color-border-button-primary-active);
  box-shadow: inset 0 0 0 2px #232aad,inset 0 0 0 3px #fff;
  box-shadow: inset 0 0 0 2px var(--osdk-color-border-button-primary-active),inset 0 0 0 3px rgba(var(--ods-color-border-focus-inner))
}
...
.onfido-sdk-ui-Theme-root .ods-button.-action--secondary:active:not(:disabled) {
  background-color: rgba(54,64,245,.1);
  background-color: var(--osdk-color-background-button-secondary-active);
  border-color: var(--osdk-color-border-button-secondary-active)
}
...
@media (hover: hover) {
  .onfido-sdk-ui-Theme-root .ods-button.-action--secondary:hover:not(:disabled) {
    ...
    border-color: #5c6cff;
    border-color: var(--osdk-color-border-button-secondary-hover)
  }
}

.onfido-sdk-ui-Theme-root .ods-button.-action--secondary:focus {
  border-color: var(--osdk-color-border-button-secondary-active);
  box-shadow: inset 0 0 0 2px rgba(var(--ods-color-border-action-active)),inset 0 0 0 3px #fff;
  box-shadow: inset 0 0 0 2px var(--osdk-color-border-button-secondary-active),inset 0 0 0 3px rgba(var(--ods-color-border-focus-inner))
}

.onfido-sdk-ui-Theme-root .ods-button.-action--secondary:disabled {
  border-color: #e9ecf0;
  border-color: rgba(var(--ods-color-border-disabled));
  color: #828893;
  color: rgba(var(--ods-color-content-disabled))
...
.onfido-sdk-ui-Theme-cobrandFooter .onfido-sdk-ui-Theme-logo,.onfido-sdk-ui-Theme-cobrandFooter .onfido-sdk-ui-Theme-logoCobrandImage,.onfido-sdk-ui-Theme-footer .onfido-sdk-ui-Theme-logo {
...
.onfido-sdk-ui-Theme-cobrandFooter .onfido-sdk-ui-Theme-logo {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='67' height='32' fill='%23636670' fill-rule='evenodd'%3E%3Cpath d='M44.908 8.307a1.01 1.01 0 0 1 .74-.307 1.03 1.03 0 0 1 .74.307c.204.204.306.455.306.74s-.102.537-.306.74a1.01 1.01 0 0 1-.74.307c-.3 0-.536-.102-.74-.307s-.306-.455-.306-.74.102-.537.306-.74zm1.428 3.373h-1.372v8.126h1.372V11.68zm5.485-.225a4.01 4.01 0 0 1 3 1.364V8.383h1.372v11.422H54.82v-1.14a4.036 4.036 0 0 1-3 1.365c-2.27 0-4.117-1.927-4.117-4.288s1.847-4.288 4.117-4.288zm.087 7.277c1.587 0 2.883-1.34 2.883-3s-1.296-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zm5.53-3a4.29 4.29 0 0 1 4.281-4.288A4.29 4.29 0 0 1 66 15.743c0 2.36-1.924 4.288-4.28 4.288s-4.28-1.927-4.28-4.288zm4.28 3c1.587 0 2.883-1.34 2.883-3s-1.3-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zm-20.663-8.657v1.605h2.32v1.273h-2.32v6.858h-1.372v-6.853h-1.52v-1.273h1.52V10.05a1.95 1.95 0 0 1 1.944-1.947h1.75v1.252h-1.602a.72.72 0 0 0-.719.721zm-6.944 1.38c-1.2 0-2.097.486-2.617 1.4V11.68H30.12v8.126h1.373V15.58c0-.853.214-1.543.638-2.054.423-.506 1-.76 1.755-.76.622 0 1.128.204 1.5.608s.55 1.032.55 1.85v4.58H37.3v-4.84c0-1.16-.28-2.05-.837-2.632-.54-.562-1.378-.874-2.352-.874zm-13.86 4.288a4.29 4.29 0 0 1 4.281-4.288 4.29 4.29 0 0 1 4.281 4.288 4.29 4.29 0 0 1-4.281 4.288 4.293 4.293 0 0 1-4.28-4.288zm4.286 3c1.587 0 2.883-1.34 2.883-3s-1.296-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zM10.16 15.52c0 1.473-1.2 2.666-2.66 2.666s-2.66-1.194-2.66-2.666 1.2-2.666 2.66-2.666 2.66 1.194 2.66 2.666zm-6.564 5.52.445-.3a7.078 7.078 0 0 1 7.323.01c.085.05.085.17.005.226l-.064.04-.366.23a14.26 14.26 0 0 1-2.529 1.198 15.37 15.37 0 0 1-1.859.536 1.95 1.95 0 0 1-1.7-.426 16.29 16.29 0 0 1-1.275-1.223c-.085-.1-.07-.23.03-.3zm7.364-10.753.445-.3c.1-.07.115-.2.03-.3a16.44 16.44 0 0 0-1.275-1.223 1.97 1.97 0 0 0-1.7-.426c-.645.145-1.265.32-1.86.536a14.3 14.3 0 0 0-2.53 1.198l-.43.27a.134.134 0 0 0 .005.226 7.078 7.078 0 0 0 7.323.01zM2.28 12.05a6.79 6.79 0 0 0-.29-.446c-.07-.1-.2-.115-.3-.03-.42.396-.83.822-1.22 1.278-.4.47-.56 1.108-.425 1.714A15.47 15.47 0 0 0 .58 16.43a14.31 14.31 0 0 0 1.195 2.536l.27.43c.055.08.175.08.225-.005 1.315-2.18 1.4-5 .01-7.342zm10.727 7.382-.3-.446a7.125 7.125 0 0 1 .01-7.342.133.133 0 0 1 .225-.005l.04.064.23.367a14.34 14.34 0 0 1 1.195 2.536 13.84 13.84 0 0 1 .535 1.864 1.987 1.987 0 0 1-.425 1.714 16.47 16.47 0 0 1-1.22 1.278c-.1.085-.23.07-.3-.03z'/%3E%3C/svg%3E");
  flex: 0 0 auto;
  margin-top: 0;
  width: 5em
}
...
.onfido-sdk-ui-Theme-fullScreenStep.onfido-sdk-ui-Theme-onfidoCobrandLogo .onfido-sdk-ui-Theme-cobrandFooter .onfido-sdk-ui-Theme-logo {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='67' height='32' fill='%23fff' fill-rule='evenodd'%3E%3Cpath d='M44.908 8.307a1.01 1.01 0 0 1 .74-.307 1.03 1.03 0 0 1 .74.307c.204.204.306.455.306.74s-.102.537-.306.74a1.01 1.01 0 0 1-.74.307c-.3 0-.536-.102-.74-.307s-.306-.455-.306-.74.102-.537.306-.74zm1.428 3.373h-1.372v8.126h1.372V11.68zm5.485-.225a4.01 4.01 0 0 1 3 1.364V8.383h1.372v11.422H54.82v-1.14a4.036 4.036 0 0 1-3 1.365c-2.27 0-4.117-1.927-4.117-4.288s1.847-4.288 4.117-4.288zm.087 7.277c1.587 0 2.883-1.34 2.883-3s-1.296-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zm5.53-3a4.29 4.29 0 0 1 4.281-4.288A4.29 4.29 0 0 1 66 15.743c0 2.36-1.924 4.288-4.28 4.288s-4.28-1.927-4.28-4.288zm4.28 3c1.587 0 2.883-1.34 2.883-3s-1.3-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zm-20.663-8.657v1.605h2.32v1.273h-2.32v6.858h-1.372v-6.853h-1.52v-1.273h1.52V10.05a1.95 1.95 0 0 1 1.944-1.947h1.75v1.252h-1.602a.72.72 0 0 0-.719.721zm-6.944 1.38c-1.2 0-2.097.486-2.617 1.4V11.68H30.12v8.126h1.373V15.58c0-.853.214-1.543.638-2.054.423-.506 1-.76 1.755-.76.622 0 1.128.204 1.5.608s.55 1.032.55 1.85v4.58H37.3v-4.84c0-1.16-.28-2.05-.837-2.632-.54-.562-1.378-.874-2.352-.874zm-13.86 4.288a4.29 4.29 0 0 1 4.281-4.288 4.29 4.29 0 0 1 4.281 4.288 4.29 4.29 0 0 1-4.281 4.288 4.293 4.293 0 0 1-4.28-4.288zm4.286 3c1.587 0 2.883-1.34 2.883-3s-1.296-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zM10.16 15.52c0 1.473-1.2 2.666-2.66 2.666s-2.66-1.194-2.66-2.666 1.2-2.666 2.66-2.666 2.66 1.194 2.66 2.666zm-6.564 5.52.445-.3a7.078 7.078 0 0 1 7.323.01c.085.05.085.17.005.226l-.064.04-.366.23a14.26 14.26 0 0 1-2.529 1.198 15.37 15.37 0 0 1-1.859.536 1.95 1.95 0 0 1-1.7-.426 16.29 16.29 0 0 1-1.275-1.223c-.085-.1-.07-.23.03-.3zm7.364-10.753.445-.3c.1-.07.115-.2.03-.3a16.44 16.44 0 0 0-1.275-1.223 1.97 1.97 0 0 0-1.7-.426c-.645.145-1.265.32-1.86.536a14.3 14.3 0 0 0-2.53 1.198l-.43.27a.134.134 0 0 0 .005.226 7.078 7.078 0 0 0 7.323.01zM2.28 12.05a6.79 6.79 0 0 0-.29-.446c-.07-.1-.2-.115-.3-.03-.42.396-.83.822-1.22 1.278-.4.47-.56 1.108-.425 1.714A15.47 15.47 0 0 0 .58 16.43a14.31 14.31 0 0 0 1.195 2.536l.27.43c.055.08.175.08.225-.005 1.315-2.18 1.4-5 .01-7.342zm10.727 7.382-.3-.446a7.125 7.125 0 0 1 .01-7.342.133.133 0 0 1 .225-.005l.04.064.23.367a14.34 14.34 0 0 1 1.195 2.536 13.84 13.84 0 0 1 .535 1.864 1.987 1.987 0 0 1-.425 1.714 16.47 16.47 0 0 1-1.22 1.278c-.1.085-.23.07-.3-.03z'/%3E%3C/svg%3E");
  margin-top: 0;
  width: 5em;
  z-index: 0
}
...
.onfido-sdk-ui-Theme-defaultLogo .onfido-sdk-ui-Theme-footer .onfido-sdk-ui-Theme-logo {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height
04.064.23.367a14.34 14.34 0 0 1 1.195 2.536 13.84 13.84 0 0 1 .535 1.864 1.987 1.987 0 0 1-.425 1.714 16.47 16.47 0 0 1-1.22 1.278c-.1.085-.23.07-.3-.03z' fill-rule='evenodd' fill='%23636670'/%3E%3Cpath d='M89.32 17.98c-.1.03-.23.05-.4.05-.25 0-.48-.1-.66-.45l-.7-1.35c.8-.3 1.33-.96 1.33-1.94 0-1.4-.95-2.15-2.4-2.15h-2.66V19h1.22v-2.6h1.2l.8 1.53c.35.66.72 1.1 1.68 1.1.27 0 .5-.04.66-.1l-.07-.98zm-4.28-4.82h1.44c.77 0 1.17.47 1.17 1.14s-.4 1.14-1.17 1.14h-1.44v-2.28zm9.494 3.42c0-1.53-.84-2.53-2.3-2.53-1.4 0-2.42 1.03-2.42 2.5 0 1.45.9 2.5 2.4 2.5 1.43 0 2.1-.8 2.28-1.65h-1.15c-.08.3-.35.68-1.08.68-.7 0-1.17-.45-1.26-1.25h3.5v-.25zm-2.28-1.6c.6 0 1.02.34 1.12 1.1h-2.33c.13-.72.6-1.1 1.2-1.1zm7.89 2.98a.65.65 0 0 1-.25.05c-.15 0-.25-.1-.25-.3V16c0-1.22-.75-1.95-2.14-1.95-1.25 0-2.1.6-2.18 1.7h1.12c.05-.48.4-.76 1-.76.68 0 1.02.36 1.02.93v.25h-.76c-1.34 0-2.5.38-2.5 1.54 0 .8.57 1.33 1.66 1.33 1.05 0 1.48-.5 1.64-.8.14.53.53.8 1.06.8a2.57 2.57 0 0 0 .66-.09l-.08-1zm-2.96.17c-.54 0-.8-.2-.8-.55 0-.46.44-.7 1.24-.7h.82v.32c0 .42-.47.93-1.27.93zm5.468-.17c-.1.04-.16.05-.24.05-.15 0-.26-.1-.26-.3V11.9h-1.2v5.92c0 .78.4 1.23 1.12 1.23.27 0 .48-.04.67-.1l-.08-1zm3.243 1.03h1.22v-6.86h-1.22V19zm5.984-7.1v2.9c-.27-.44-.75-.74-1.5-.74-1.36 0-2.23 1.06-2.23 2.56 0 1.52.9 2.44 2.16 2.44.75 0 1.28-.34 1.57-.8l.03.74h1.18v-7.1h-1.22zm-1.3 6.12c-.73 0-1.2-.56-1.2-1.44 0-.9.5-1.5 1.2-1.5.84 0 1.28.7 1.28 1.33v.3c0 .6-.43 1.32-1.3 1.32zm8.187-1.44c0-1.53-.84-2.53-2.3-2.53-1.4 0-2.42 1.03-2.42 2.5 0 1.45.9 2.5 2.4 2.5 1.43 0 2.1-.8 2.28-1.65h-1.15c-.08.3-.35.68-1.08.68-.7 0-1.17-.45-1.26-1.25h3.5v-.25zm-2.28-1.6c.6 0 1.02.34 1.12 1.1h-2.33c.13-.72.6-1.1 1.2-1.1zm6.01-.94c-.74 0-1.25.3-1.54.76l-.04-.7h-1.17V19h1.22v-2.78c0-.67.43-1.12 1.1-1.12.62 0 .94.4.94 1.1V19h1.23v-3.08c0-1.13-.64-1.87-1.73-1.87zm5.604 3.25c0 .54-.23.76-.63.76s-.6-.24-.6-.76v-2.22h1.73v-.98h-1.73v-1.45h-1.15v1.45h-.8v1h.73v2.18c0 1.16.68 1.77 1.78 1.77 1.14 0 1.76-.64 1.76-1.74h-1.08zm3.25-4.8c0-.44-.35-.77-.8-.77s-.8.33-.8.77c0 .46.35.78.8.78s.8-.32.8-.78zm-1.42 6.5h1.22v-4.9h-1.22V19zm5.2-1.7c0 .54-.23.76-.63.76s-.6-.24-.6-.76v-2.22h1.73v-.98h-1.73v-1.45h-1.15v1.45h-.8v1h.73v2.18c0 1.16.68 1.77 1.78 1.77 1.14 0 1.76-.64 1.76-1.74h-1.08zm4.872-3.2-1.05 3.2a3.46 3.46 0 0 0-.13.55h-.03l-.14-.55-1.04-3.2h-1.33l1.9 5.02-.08.2c-.2.57-.56.7-1 .7a1.16 1.16 0 0 1-.47-.1l-.08 1.03c.18.06.5.1.8.1 1 0 1.5-.47 1.97-1.7l.14-.37 1.8-4.9h-1.24z' fill='%23636670'/%3E%3Cpath stroke='%23636670' stroke-width='.7' d='M75.35 6v19'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-Theme-fullScreenStep.onfido-sdk-ui-Theme-defaultLogo .onfido-sdk-ui-Theme-footer .onfido-sdk-ui-Theme-logo {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height='32' fill='none'%3E%3Cpath d='M46.908 8.307a1.01 1.01 0 0 1 .74-.307 1.03 1.03 0 0 1 .74.307c.204.204.306.455.306.74s-.102.537-.306.74a1.01 1.01 0 0 1-.74.307c-.3 0-.536-.102-.74-.307s-.306-.455-.306-.74c0-.3.102-.537.306-.74zm1.428 3.373h-1.372v8.126h1.372V11.68zm5.485-.225a4.01 4.01 0 0 1 3 1.364V8.383h1.372v11.422H56.82v-1.14a4.036 4.036 0 0 1-3 1.365c-2.27 0-4.117-1.927-4.117-4.288s1.847-4.288 4.117-4.288zm.087 7.277c1.587 0 2.883-1.34 2.883-3s-1.296-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zm5.53-3a4.29 4.29 0 0 1 4.281-4.288A4.29 4.29 0 0 1 68 15.743c0 2.36-1.924 4.288-4.28 4.288s-4.28-1.927-4.28-4.288zm4.28 3c1.587 0 2.883-1.34 2.883-3s-1.3-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zm-20.663-8.657v1.605h2.32v1.273h-2.32v6.858h-1.372v-6.853h-1.52v-1.273h1.52V10.05a1.95 1.95 0 0 1 1.944-1.947h1.75v1.252h-1.602a.72.72 0 0 0-.719.721zm-6.944 1.38c-1.2 0-2.097.486-2.617 1.4V11.68H32.12v8.126h1.373V15.58c0-.853.214-1.543.638-2.054.423-.506 1-.76 1.755-.76.622 0 1.128.204 1.5.608s.55 1.032.55 1.85v4.58H39.3v-4.84c0-1.16-.28-2.05-.837-2.632-.54-.562-1.378-.874-2.352-.874zm-13.86 4.288a4.29 4.29 0 0 1 4.281-4.288 4.29 4.29 0 0 1 4.281 4.288 4.29 4.29 0 0 1-4.281 4.288 4.293 4.293 0 0 1-4.28-4.288zm4.286 3c1.587 0 2.883-1.34 2.883-3s-1.296-3-2.883-3-2.883 1.34-2.883 3 1.3 3 2.883 3zM12.16 15.52c0 1.472-1.2 2.666-2.66 2.666s-2.66-1.194-2.66-2.666 1.2-2.666 2.
.03h1.22v-6.86h-1.22V19zm5.984-7.1v2.9c-.27-.44-.75-.74-1.5-.74-1.36 0-2.23 1.06-2.23 2.56 0 1.52.9 2.44 2.16 2.44.75 0 1.28-.34 1.57-.8l.03.74h1.18v-7.1h-1.22zm-1.3 6.12c-.73 0-1.2-.56-1.2-1.44 0-.9.5-1.5 1.2-1.5.84 0 1.28.7 1.28 1.33v.3c0 .6-.43 1.32-1.3 1.32zm8.187-1.44c0-1.53-.84-2.53-2.3-2.53-1.4 0-2.42 1.03-2.42 2.5 0 1.45.9 2.5 2.4 2.5 1.43 0 2.1-.8 2.28-1.65h-1.15c-.08.3-.35.68-1.08.68-.7 0-1.17-.45-1.26-1.25h3.5v-.25zm-2.28-1.6c.6 0 1.02.34 1.12 1.1h-2.33c.13-.72.6-1.1 1.2-1.1zm6.01-.94c-.74 0-1.25.3-1.54.76l-.04-.7h-1.17V19h1.22v-2.78c0-.67.43-1.12 1.1-1.12.62 0 .94.4.94 1.1V19h1.23v-3.08c0-1.13-.64-1.87-1.73-1.87zm5.604 3.25c0 .54-.23.76-.63.76s-.6-.24-.6-.76v-2.22h1.73v-.98h-1.73v-1.45h-1.15v1.45h-.8v1h.73v2.18c0 1.16.68 1.77 1.78 1.77 1.14 0 1.76-.64 1.76-1.74h-1.08zm3.25-4.8c0-.44-.35-.77-.8-.77s-.8.33-.8.77c0 .46.35.78.8.78s.8-.32.8-.78zm-1.42 6.5h1.22v-4.9h-1.22V19zm5.2-1.7c0 .54-.23.76-.63.76s-.6-.24-.6-.76v-2.22h1.73v-.98h-1.73v-1.45h-1.15v1.45h-.8v1h.73v2.18c0 1.16.68 1.77 1.78 1.77 1.14 0 1.76-.64 1.76-1.74h-1.08zm4.872-3.2-1.05 3.2a3.46 3.46 0 0 0-.13.55h-.03l-.14-.55-1.04-3.2h-1.33l1.9 5.02-.08.2c-.2.57-.56.7-1 .7a1.16 1.16 0 0 1-.47-.1l-.08 1.03c.18.06.5.1.8.1 1 0 1.5-.47 1.97-1.7l.14-.37 1.8-4.9h-1.24z' fill='%23fff'/%3E%3Cpath stroke='%23fff' stroke-width='.7' d='M75.35 6v19'/%3E%3C/svg%3E")
}
...
[dir=ltr] .onfido-sdk-ui-Theme-header {
  margin-left: .7142857143em
}

[dir=rtl] .onfido-sdk-ui-Theme-header {
...
.onfido-sdk-ui-Theme-help {
  border-radius: .5em;
  box-shadow: inset 0 0 0 .0625em #636670;
...
[dir=ltr] .onfido-sdk-ui-Theme-helpList {
  padding-left: 1.5em
}

[dir=rtl] .onfido-sdk-ui-Theme-helpList {
  padding-right: 1.5em
}
...
.onfido-sdk-ui-Theme-link,.onfido-sdk-ui-Theme-textButton {
  background-color: transparent;
  border: 1px solid transparent;
  border-bottom: 1px solid var(--osdk-color-border-link-underline);
  color: #2b2d33;
  color: var(--osdk-color-content-body);
  font-family: Open Sans,sans-serif;
  font-family: var(--osdk-font-family-body);
...
.onfido-sdk-ui-Theme-warningFallbackButton {
  background-color: transparent;
  border: 1px solid transparent;
  border-bottom: 1px solid var(--osdk-color-content-alert-info);
  color: #f7f9fa;
...
.onfido-sdk-ui-Theme-error,.onfido-sdk-ui-Theme-errorFallbackButton {
  background-color: transparent;
  border: 1px solid transparent;
  border-bottom: 1px solid var(--osdk-color-content-alert-error)
}

.onfido-sdk-ui-Theme-error:active,.onfido-sdk-ui-Theme-error:hover,.onfido-sdk-ui-Theme-errorFallbackButton:active,.onfido-sdk-ui-Theme-errorFallbackButton:hover {
  color: #f7f9fa;
  color: var(--osdk-color-content-alert-error)
}

@media (hover: hover) {
  .onfido-sdk-ui-Theme-error:hover,.onfido-sdk-ui-Theme-errorFallbackButton:hover {
    background-color:#f54e4e;
    background-color: var(--osdk-color-background-alert-error-link-hover)
  }
}

.onfido-sdk-ui-Theme-error:active,.onfido-sdk-ui-Theme-errorFallbackButton:active {
  background-color: #a00;
...
.onfido-sdk-ui-NavigationBar-iconBack {
  background-color: transparent;
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='32' height='32' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Ccircle cx='16' cy='16' r='16'/%3E%3Cpath d='M16.668 11.811 11.738 16l4.93 4.189a1.014 1.014 0 0 1 0 1.5 1.191 1.191 0 0 1-1.604 0l-5.736-4.873A1.01 1.01 0 0 1 9.003 16a1.01 1.01 0 0 1 .325-.816l5.736-4.873a1.191 1.191 0 0 1 1.604 0 1.014 1.014 0 0 1 0 1.5z' fill='%232C3E4F' fill-rule='nonzero'/%3E%3Crect fill='%232C3E4F' fill-rule='nonzero' x='9' y='15' width='16' height='2' rx='1'/%3E%3C/g%3E%3C/svg%3E");
  background-position: 50%;
  background-repeat: no-repeat;
  background-size: contain;
  border-radius: 1em;
...
[dir=rtl] .onfido-sdk-ui-NavigationBar-iconBack {
  transform: scale(-1)
}

.onfido-sdk-ui-NavigationBar-transparent {
  background: linear-gradient(0deg,rgba(28,31,33,0),rgba(28,31,33,.35));
  z-index: 3
}
...
.onfido-sdk-ui-NavigationBar-transparent .onfido-sdk-ui-NavigationBar-iconBack {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='32' height='32' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Ccircle cx='16' cy='16' r='16'/%3E%3Cpath d='M16.668 11.811 11.738 16l4.93 4.189a1.014 1.014 0 0 1 0 1.5 1.191 1.191 0 0 1-1.604 0l-5.736-4.873A1.01 1.01 0 0 1 9.003 16a1.01 1.01 0 0 1 .325-.816l5.736-4.873a1.191 1.191 0 0 1 1.604 0 1.014 1.014 0 0 1 0 1.5z' fill='%23FFF' fill-rule='nonzero'/%3E%3Crect fill='%23FFF' fill-rule='nonzero' x='9' y='15' width='16' height='2' rx='1'/%3E%3C/g%3E%3C/svg%3E")
}

.onfido-sdk-ui-NavigationBar-backHoverDesktop:focus-visible .onfido-sdk-ui-NavigationBar-label,.onfido-sdk-ui-NavigationBar-backHoverDesktop:hover .onfido-sdk-ui-NavigationBar-label {
  visibility: visible
}
...
.onfido-sdk-ui-PageTitle-title:focus {
  outline: none
}
...
.onfido-sdk-ui-PageTitle-fullScreen,.onfido-sdk-ui-PageTitle-fullScreen .onfido-sdk-ui-PageTitle-subTitle,.onfido-sdk-ui-PageTitle-fullScreen .onfido-sdk-ui-PageTitle-title {
  color: #fff;
  color: rgb(var(--ods-color-neutral-white))
}
...
.onfido-sdk-ui-GenericError-flowInterruptedIcon,.onfido-sdk-ui-GenericError-genericErrorIcon,.onfido-sdk-ui-GenericError-unsupportedBrowserIcon {
  background-size: contain;
  height: 9em;
  margin-left: auto;
  margin-right: auto;
...
.onfido-sdk-ui-GenericError-genericErrorIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height
m8 0c0-1.1.9-2 2-2 1.12 0 2 .9 2 2s-.88 2-2 2c-1.1 0-2-.9-2-2zm-47.98.142c-.02-.04-.02-.1-.02-.16a2.033 2.033 0 0 1 1.88-1.977c1.1-.08 2.04.759 2.12 1.858v.16c0 1.039-.8 1.898-1.84 1.977h-.14c-1.06 0-1.94-.799-2-1.858zM98.398 23.2A2.07 2.07 0 0 1 98 21.999c0-.6.28-1.201.8-1.601.88-.66 2.14-.48 2.8.4.28.36.4.78.4 1.201 0 .62-.28 1.221-.8 1.601-.36.28-.78.4-1.2.4a2.03 2.03 0 0 1-1.602-.8zM38.04 24.76a2.023 2.023 0 0 1-.8-2.726 1.999 1.999 0 0 1 2.72-.782 2 2 0 0 1 .8 2.706h-.02A1.948 1.948 0 0 1 39 25c-.32 0-.66-.08-.96-.241zM100 30c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm-64 1c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm0 8c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm0 8c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2z'/%3E%3C/g%3E%3Cpath d='M68 30c6.627 0 12-5.373 12-12S74.627 6 68 6s-12 5.373-12 12 5.373 12 12 12z' fill='%23e61c1c'/%3E%3Cpath fill-rule='evenodd' d='M73.568 12.433c.576.576.576 1.51 0 2.086l-3.481 3.482 3.481 3.481a1.475 1.475 0 0 1-2.086 2.086l-3.481-3.481-3.482 3.481a1.475 1.475 0 0 1-2.086-2.086l3.482-3.481-3.482-3.482a1.475 1.475 0 0 1 2.086-2.086l3.482 3.482 3.481-3.482a1.475 1.475 0 0 1 2.086 0z' fill='%23fff'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-GenericError-flowInterruptedIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height='144' fill-rule='evenodd'%3E%3Cg fill='%23fff'%3E%3Crect stroke='%232c3e4f' stroke-width='4' x='50' y='34' width='44' height='76' rx='8'/%3E%3Ccircle stroke='%23283e4f' stroke-width='2' cx='72' cy='101' r='4'/%3E%3C/g%3E%3Crect fill='%232c3e4f' x='63' y='40' width='18' height='2' rx='1'/%3E%3Ccircle fill='%23e61c1c' cx='94' cy='34' r='12'/%3E%3Cpath d='m91.914 34-3.481-3.481a1.475 1.475 0 0 1 2.086-2.086L94 31.914l3.481-3.481a1.475 1.475 0 0 1 2.086 2.086L96.086 34l3.481 3.481a1.475 1.475 0 0 1-2.086 2.086L94 36.086l-3.481 3.481a1.475 1.475 0 0 1-2.086-2.086L91.914 34z' fill='%23fff'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-GenericError-unsupportedBrowserIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='54' height='54' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Ccircle fill='%23E61C1C' cx='27' cy='27' r='27'/%3E%3Cpath d='m38.223 13.17 2.608 2.607c.576.576.576 1.51 0 2.086l-9.138 9.136 9.138 9.138c.576.576.576 1.51 0 2.086l-2.608 2.608a1.475 1.475 0 0 1-2.086 0L27 31.693l-9.136 9.138a1.475 1.475 0 0 1-2.086 0l-2.608-2.608a1.475 1.475 0 0 1 0-2.086L22.306 27l-9.137-9.136a1.475 1.475 0 0 1 0-2.086l2.608-2.608a1.475 1.475 0 0 1 2.086 0l9.136 9.137 9.138-9.137a1.475 1.475 0 0 1 2.086 0z' fill='%23FFF'/%3E%3C/g%3E%3C/svg%3E");
  height: 3.375em
}

[dir=rtl] .onfido-sdk-ui-Welcome-recordingLimit .onfido-sdk-ui-Welcome-timer {
  transform: scaleX(-1)
}
...
.onfido-sdk-ui-Welcome-recordingLimit>.onfido-sdk-ui-Welcome-timer {
  align-self: stretch;
  background: url("data:image/svg+xml;charset=utf-8,%3Csvg width='15' height='13' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M9 3a4.672 4.672 0 0 0-4.667 4.667A4.672 4.672 0 0 0 9 12.333a4.672 4.672 0 0 0 4.667-4.666A4.672 4.672 0 0 0 9 3Zm0 8a3.337 3.337 0 0 1-3.333-3.333A3.337 3.337 0 0 1 9 4.333a3.337 3.337 0 0 1 3.334 3.334A3.337 3.337 0 0 1 9 11Zm-.666-5.333h1.333v2.666H8.334V5.667ZM7 .333h4v1.334H7V.333Zm-6 4h2.667v1.334H1V4.333Zm0 5.334h2.667V11H1V9.667ZM.333 7h2.66v1.333H.333V7Zm12.862-3.529-1.333-1.333.943-.943 1.333 1.334-.943.942Z' fill='%232B2D33'/%3E%3C/svg%3E") 0 no-repeat;
  width: 1.25em
}
...
[dir=ltr] [dir=rtl] .onfido-sdk-ui-Welcome-recordingLimit .onfido-sdk-ui-Welcome-timer {
  margin-right: .5em
}

[dir=rtl] [dir=rtl] .onfido-sdk-ui-Welcome-recordingLimit .onfido-sdk-ui-Welcome-timer {
  margin-left: .5em
}
...
.onfido-sdk-ui-Welcome-balanceContainer>.onfido-sdk-ui-Welcome-balance {
  align-self: stretch;
  background: url("data:image/svg+xml;charset=utf-8,%3Csvg width='544' height='405' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M521.754 373.884s-.239 7.24-3.743 11.862c-3.503 4.621-4.069 6.324-10.056 8.472-5.988 2.148-7.572 4.279-8.026 9.594 0 0 11.529 0 16.386-.112 4.857-.111 8.566 0 14.348-6.324S544 381.236 544 381.236l-22.271-7.352m-63.182 3.997s-4.686 9.628-14.69 12.606c-10.005 2.978-15.342 2.764-18.537 13.513h51.978l-18.751-26.119Z' fill='%231B1263'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='m521.754 373.884-29.064-58.092c-.111-22.79-4.086-43.714-3.966-51.348.103-6.615-.582-11.065.488-19.889.446 2.705 3.024 16.842 10.065 26.385 7.829 10.594 22.169 28.566 29.801 44.655 7.846 16.569 7.581 45.418-7.324 58.289Z' fill='%23343EE0'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='m521.754 373.884-29.064-58.092c-.111-22.79-4.086-43.714-3.966-51.348.103-6.615-.582-11.065.488-19.889.446 2.705 3.024 16.842 10.065 26.385 7.829 10.594 22.169 28.566 29.801 44.655 7.846 16.569 7.581 45.418-7.324 58.289Z' fill='url(%23a)'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M469.366 181.739s-10.1 57.681-10.348 80.018c-.248 22.336-.471 116.124-.471 116.124s27.077-5.708 32.293-36.671c5.217-30.963-2.278-66.325-2.116-76.757.163-10.433-1.636-15.482 4.566-40.745 6.202-25.264 7.178-28.353 7.178-28.353l-5.996-21.352-25.064 7.702' fill='%23343EE0'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='m437.937 253.122 37.476 13.744 7.872-22.191-37.056-13.915-8.292 22.362Z' fill='%23FF7D75'/%3E%3Cmask id='b' style='mask-type:alpha' maskUnits='userSpaceOnUse' x='455' y='93' width='28' height='157'%3E%3Cpath d='M471.25 223.948s3.161 5.896 1.919 11.279-3.315 9.611-8.121 12.426c-4.805 2.816-8.043 2.405-8.788 1.661-.745-.745-.994-1.002-.086-2.157s3.735-3.894 4.729-6.624c.993-2.73 1.079-3.894-.583-4.476-1.662-.582-3.675-1.386-3.675-1.386a31.863 31.863 0 0 1 5.337-4.741c2.321-1.413 9.268-5.982 9.268-5.982Zm2.047-130.228 6.236 3.757 1.362 10.141a11.776 11.776 0 0 1-2.259 2.794l-.011-.03a18.24
gradientUnits='userSpaceOnUse'%3E%3Cstop stop-opacity='0'/%3E%3Cstop offset='1' stop-opacity='.2'/%3E%3C/linearGradient%3E%3ClinearGradient id='j' x1='364.091' y1='111.371' x2='365.209' y2='117.432' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-opacity='.3'/%3E%3Cstop offset='1' stop-opacity='0'/%3E%3C/linearGradient%3E%3ClinearGradient id='m' x1='73.473' y1='124.075' x2='75.46' y2='129.873' gradientUnits='userSpaceOnUse'%3E%3Cstop stop-opacity='.1'/%3E%3Cstop offset='1' stop-opacity='0'/%3E%3C/linearGradient%3E%3C/defs%3E%3C/svg%3E") 50% no-repeat;
  background-size: 60%;
  height: 100%;
  width: 100%
}
...
.onfido-sdk-ui-UserConsent-consentFrame ol li:not(:first-child) {
  margin-top: 16px
}
...
.onfido-sdk-ui-UserConsent-declineModalInner,.onfido-sdk-ui-UserConsent-declineModalInner *,.onfido-sdk-ui-UserConsent-declineModalInner :after,.onfido-sdk-ui-UserConsent-declineModalInner :before {
  box-sizing: border-box
}
...
.onfido-sdk-ui-UserConsent-errorIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='40' height='40' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M19.906 0C8.93 0 0 8.972 0 20s8.972 20 20 20 20-8.972 20-20S30.986 0 19.906 0zM20 36c-8.822 0-16-7.178-16-16S11.134 4 19.906 4C28.782 4 36 11.178 36 20s-7.178 16-16 16zm-2-26h4v12h-4V10zm0 16h4v4h-4v-4z' fill='%23BDC3FF'/%3E%3C/svg%3E");
  background-size: contain;
  height: 2.5em
}

.onfido-sdk-ui-UserConsent-screenLayout+div {
...
.onfido-sdk-ui-Uploader-faceIcon,.onfido-sdk-ui-Uploader-icon,.onfido-sdk-ui-Uploader-identityIcon,.onfido-sdk-ui-Uploader-proofOfAddressIcon,.onfido-sdk-ui-Uploader-uploadDocumentIcon {
  background-color: #e9ecf0;
  background-color: var(--osdk-color-background-icon);
  border-radius: 50%
}
...
.onfido-sdk-ui-Uploader-primaryButton {
  margin-bottom: 1em;
  margin-top: 1em
}
...
.onfido-sdk-ui-Uploader-icon,.onfido-sdk-ui-Uploader-identityIcon,.onfido-sdk-ui-Uploader-proofOfAddressIcon,.onfido-sdk-ui-Uploader-uploadDocumentIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 42 48'%3E%3Cdefs%3E%3Ccircle id='b' cx='14' cy='43' r='2'/%3E%3Crect id='a' width='28' height='48' rx='4'/%3E%3Cpath id='c' d='M2 0h28a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z'/%3E%3C/defs%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg transform='translate(14)'%3E%3Cuse fill='%23fff' xlink:href='%23a'/%3E%3Crect x='1' y='1' width='26' height='46' rx='4' stroke='%232c3e4f' stroke-width='2'/%3E%3Crect x='9' y='4' width='10' height='1' rx='.5' fill='%232c3e4f'/%3E%3Cuse fill='%23fff' xlink:href='%23b'/%3E%3Ccircle cx='14' cy='43' r='1.5' stroke='%232c3e4f'/%3E%3C/g%3E%3Cg transform='rotate(-15 73.233 8.64)'%3E%3Cuse fill='%23fff' xlink:href='%23c'/%3E%3Cpath d='M2 .5A1.5 1.5 0 0 0 .5 2v16A1.5 1.5 0 0 0 2 19.5h28a1.5 1.5 0 0 0 1.5-1.5V2A1.5 1.5 0 0 0 30 .5H2z' stroke='%23283e4f'/%3E%3Cg fill='%23283e4f'%3E%3Crect y='11' width='13' height='1' rx='.5' x='16'/%3E%3Crect x='19' y='8' width='10' height='1' rx='.5'/%3E%3Crect x='21' width='2' height='1' rx='.5' y='5'/%3E%3Crect x='24' width='2' height='1' rx='.5' y='5'/%3E%3Crect x='27' width='2' height='1' rx='.5' y='5'/%3E%3C/g%3E%3Cg stroke='%23283e4f'%3E%3Cpath d='M13.074 18.4c-1.188-2.369-3.08-3.8-5.103-3.8-1.949 0-3.82 1.449-5.032 3.8h10.136z' stroke-width='1.2'/%3E%3Cpath d='M8 12.5c2.346 0 4.5-2.648 4.5-5.367C12.5 4.572 10.483 2.5 8 2.5c-1.651 0-3.146.923-3.935 2.384A4.711 4.711 0 0 0 3.5 7.133C3.5 9.852 5.654 12.5 8 12.5z'/%3E%3C/g%3E%3C/g%3E%3Cpath fill='%23283e4f' d='M14 12h2v31h-2z'/%3E%3Cpath fill='%23fff' fill-opacity='.67' d='M16 10h24v27H16z'/%3E%3Cpath stroke='%23fff' d='M16.5 10.5h23v26h-23z'/%3E%3C/g%3E%3C/svg%3E");
...
.onfido-sdk-ui-Uploader-uploadDocumentIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='62' height='79' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M60.73 24.776c-.184-.399-.413-.779-.737-1.102L37.422 1.102C37.098.78 36.718.55 36.319.365c-.113-.053-.233-.083-.353-.124a3.73 3.73 0 0 0-.975-.192C34.912.04 34.841 0 34.761 0H8.43C4.279 0 .905 3.374.905 7.524v60.19c0 4.15 3.374 7.524 7.524 7.524H53.57c4.15 0 7.524-3.374 7.524-7.524v-41.38c0-.08-.041-.151-.049-.234a3.585 3.585 0 0 0-.191-.974c-.038-.12-.072-.237-.125-.35Z' fill='%23fff'/%3E%3Cpath d='M60.73 24.776c-.184-.399-.413-.779-.737-1.102L37.422 1.102C37.098.78 36.718.55 36.319.365c-.113-.053-.233-.083-.353-.124a3.73 3.73 0 0 0-.975-.192C34.912.04 34.841 0 34.761 0H8.43C4.279 0 .905 3.374.905 7.524v60.19c0 4.15 3.374 7.524 7.524 7.524H53.57c4.15 0 7.524-3.374 7.524-7.524v-41.38c0-.08-.041-.151-.049-.234a3.585 3.585 0 0 0-.191-.974c-.038-.12-.072-.237-.125-.35Zm-4.65.35H35.965V5.016l20.113 20.11ZM5.92 70.222V5.016H31v21.317a3.758 3.758 0 0 0 3.762 3.762h21.317v40.127H5.921Z' fill='%231E1E24'/%3E%3Cpath d='M41 47.75H31a1.25 1.25 0 1 0 0 2.5h10a1.25 1.25 0 1 0 0-2.5ZM46 42.75H31a1.25 1.25 0 1 0 0 2.5h15a1.25 1.25 0 1 0 0-2.5Z' fill='%232B2D33'/%3E%3Cpath d='M16.013 56.5H27.25c0-2.5-3.057-5-5.625-5s-5.612 2.5-5.612 5Zm5.612-8.75c1.593 0 3.125-1.712 3.125-3.417 0-1.544-1.38-2.833-3.125-2.833-1.17 0-2.214.587-2.754 1.494-.243.409-.37.865-.37 1.34 0 1.704 1.53 3.416 3.124 3.416Z' fill='%23fff' stroke='%232B2D33' stroke-width='2' stroke-linejoin='round'/%3E%3C/svg%3E");
  background-position: 50%;
...
@media (max-width: 479px) {
  ...
  .onfido-sdk-ui-Uploader-proofOfAddressIcon {
    background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height='144' fill='none'%3E%3Cpath d='M109.978 106.015a2.316 2.316 0 0 0-2.316 2.316v10.037H97.625a2.316 2.316 0 0 0 0 4.632h12.353a2.316 2.316 0 0 0 2.316-2.316v-12.353a2.316 2.316 0 0 0-2.316-2.316zm-75.662 0A2.316 2.316 0 0 0 32 108.331v12.353A2.316 2.316 0 0 0 34.316 123h12.353a2.316 2.316 0 0 0 0-4.632H36.632v-10.037a2.316 2.316 0 0 0-2.316-2.316zM97.625 18a2.316 2.316 0 0 0 0 4.632h10.037v10.037a2.316 2.316 0 0 0 4.632 0V20.322A2.317 2.317 0 0 0 109.978 18H97.625zm-63.309 0A2.316 2.316 0 0 0 32 20.316v12.353a2.316 2.316 0 0 0 4.632 0V22.632h10.037a2.316 2.316 0 0 0 0-4.632H34.316z' fill-rule='evenodd' fill='%232c3e4f'/%3E%3Cpath d='M101.485 40.466v68.246c0 1.883-1.578 3.479-3.615 3.479H46.425c-2.04 0-3.616-1.582-3.616-3.479V32.287c0-1.883 1.578-3.479 3.616-3.479h43.097l11.964 11.657z' fill='%23f7f9fa' stroke='%232c3e4f' stroke-width='3.088'/%3E%3Cg fill='%232c3e4f'%3E%3Cpath fill-rule='evenodd' d='M101.485 38.846v2.316h-9.264c-2.705 0-4.632-1.937-4.632-4.632v-9.265h2.316'/%3E%3Crect x='50.529' y='70.5' width='17.757' height='3.088' rx='1.544'/%3E%3Cpath fill-rule='evenodd' d='M50.529 62.78c0-.853.691-1.544 1.544-1.544h27.022a1.544 1.544 0 1 1 0 3.088H52.074a1.544 1.544 0 0 1-1.544-1.544z'/%3E%3Crect x='50.529' y='51.971' width='37.059' height='3.088' rx='1.544'/%3E%3C/g%3E%3C/svg%3E");
    background-size: contain
  }
}

.onfido-sdk-ui-Uploader-faceIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='0 0 48 48'%3E%3Cdefs%3E%3Ccircle id='a' cx='8' cy='8' r='7.5'/%3E%3C/defs%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill-rule='nonzero'%3E%3Crect x='13' y='9' width='22' height='38' rx='2.667' fill='%23fff' stroke='%232c3e4f' stroke-width='1.333'/%3E%3Crect x='20' y='11' width='8' height='1' rx='.5' fill='%232c3e4f'/%3E%3C/g%3E%3Cg stroke='%232c3e4f'%3E%3Cg transform='translate(16 18)'%3E%3Cmask id='b' fill='%23fff'%3E%3Cuse xlink:href='%23a'/%3E%3C/mask%3E%3Ccircle cx='12.85' cy='-.85' r='7.35' mask='url(%23b)'/%3E%3Ccircle cx='-1.65' cy='.85' r='7.35' mask='url(%23b)'/%3E%3C/g%3E%3Ccircle cx='24' cy='43' r='1.5' fill='%23fff' fill-rule='nonzero'/%3E%3C/g%3E%3Cg fill='%232c3e4f' fill-rule='nonzero'%3E%3Ccircle cx='22' cy='27' r='1'/%3E%3Ccircle cx='26' cy='27' r='1'/%3E%3C/g%3E%3Ccircle cx='24' cy='26' r='7.5' stroke='%232c3e4f'/%3E%3C/g%3E%3C/svg%3E");
...
.onfido-sdk-ui-Uploader-contentWrapper,.onfido-sdk-ui-Uploader-uploadArea,.onfido-sdk-ui-Uploader-uploaderWrapper {
  display: flex;
  flex-direction: column;
  flex-grow: 1;
  height: 1em
...
.onfido-sdk-ui-Photo-selfieIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width
con {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='48' height='48' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Cdefs%3E%3Ccircle id='a' cx='24' cy='24' r='24'/%3E%3C/defs%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cmask id='b' fill='%23fff'%3E%3Cuse xlink:href='%23a'/%3E%3C/mask%3E%3Cuse xlink:href='%23a'/%3E%3Ccircle fill='%23F7F9FA' mask='url(%23b)' cx='15' cy='24' r='7'/%3E%3Ccircle fill='%23F7F9FA' mask='url(%23b)' cx='33' cy='24' r='7'/%3E%3Cpath d='M43 23.2h-2.004c-.418-4.042-3.8-7.2-7.893-7.2-2.589 0-4.885 1.263-6.347 3.2-.626-.421-1.503-.8-2.756-.8s-2.171.379-2.756.8c-1.462-1.937-3.758-3.2-6.347-3.2-4.093 0-7.475 3.158-7.893 7.2H5v1.6h2.004c.418 4.042 3.8 7.2 7.893 7.2 4.343 0 7.934-3.579 7.934-8 0-1.221-.293-2.358-.752-3.41.376-.295 1.002-.59 1.921-.59s1.545.295 1.92.59a7.832 7.832 0 0 0-.75 3.41c0 4.379 3.549 8 7.933 8 4.093 0 7.475-3.158 7.893-7.2H43v-1.6zm-28.103 7.2c-3.508 0-6.348-2.863-6.348-6.4 0-3.537 2.84-6.4 6.348-6.4 2.171 0 4.092 1.137 5.261 2.821l.084.126c.626 1.01 1.044 2.19 1.044 3.453-.042 3.537-2.923 6.4-6.39 6.4zm18.206 0c-3.507 0-6.347-2.863-6.347-6.4 0-1.263.376-2.484 1.044-3.453l.084-.126c1.127-1.684 3.09-2.821 5.261-2.821 3.508 0 6.347 2.863 6.347 6.4-.041 3.537-2.923 6.4-6.389 6.4z' fill='%232B2D33' mask='url(%23b)'/%3E%3C/g%3E%3C/svg%3E")
}
...
[dir=rtl] .onfido-sdk-ui-BulletList-itemIcon {
  transform: scaleX(-1)
}

.onfido-sdk-ui-BulletList-content {
  display: flex;
  flex-direction: column;
  flex-grow: 1;
  justify-content: center
...
.onfido-sdk-ui-BulletList-list {
  list-style: none;
  padding: 0
}

.onfido-sdk-ui-BulletList-stage {
  align-items: center;
  display: flex;
  padding-bottom: 2em;
  position: relative
...
[dir=ltr] .onfido-sdk-ui-BulletList-stage:before {
  margin-left: 1.4375em
}

[dir=rtl] .onfido-sdk-ui-BulletList-stage:before {
...
.onfido-sdk-ui-BulletList-stage:last-child:before {
  display: none
}
...
[dir=ltr] .onfido-sdk-ui-BulletList-itemMessage {
  margin-left: .9375em
}

[dir=rtl] .onfido-sdk-ui-BulletList-itemMessage {
  margin-right: .9375em
}

.onfido-sdk-ui-BulletList-itemMessage {
  color: #2b2d33;
  color: var(--osdk-color-content-body);
  flex-basis: 100%;
  flex-grow: 1;
...
.onfido-sdk-ui-DocumentSelector-DocumentList-icon-address-certificate,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-bank-building-society-statement,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-driving-licence,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-generic-document,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-letter,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-national-identity-card,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-passport,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-residence-permit,.onfido-sdk-ui-DocumentSelector-DocumentList-icon-utility-bill {
  background-color: #e9ecf0;
  background-color: var(--osdk-color-background-icon);
  border-radius: 50%
}

[dir=rtl] .onfido-sdk-ui-DocumentSelector-DocumentList-icon {
  transform: scaleX(-1)
}
...
.onfido-sdk-ui-DocumentSelector-DocumentList-option:active {
  ...
  box-shadow: 0 0 0 2px #232aad;
  box-shadow: 0 0 0 2px var(--osdk-color-border-doc-type-button-active)
}

.onfido-sdk-ui-DocumentSelector-DocumentList-arrow {
  background: url("data:image/svg+xml;charset=utf-8,%3Csvg width='8' height='12' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M.332 1.811 5.262 6l-4.93 4.189a1.014 1.014 0 0 0 0 1.5 1.192 1.192 0 0 0 1.604 0l5.736-4.873A1.01 1.01 0 0 0 7.997 6a1.01 1.01 0 0 0-.325-.816L1.936.31a1.192 1.192 0 0 0-1.604 0 1.014 1.014 0 0 0 0 1.5z' fill='%232C3E4F'/%3E%3C/svg%3E") no-repeat;
  background-size: contain;
  height: .75em;
  width: .625em
}

[dir=rtl] .onfido-sdk-ui-DocumentSelector-DocumentList-arrow {
  transform: scale(-1)
}
...
[dir=ltr] .onfido-sdk-ui-DocumentSelector-DocumentList-icon {
  margin-right: 1em
}
...
.onfido-sdk-ui-DocumentSelector-DocumentList-icon-passport {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='-12 -6.5 48 48'%3E%3Cg fill='%23fff' stroke='%232c3e4f' stroke-width='2'%3E%3Cpath d='M1 5.762v15.95l18-4.6V2.11a1 1 0 0 0-1-1 .99.99 0 0 0-.266.036L1 5.762z'/%3E%3Cpath d='M1 6v28h20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2H1z'/%3E%3C/g%3E%3Cpath fill='%232c3e4f' d='M7 28h10a1 1 0 1 1 0 2H7a1 1 0 1 1 0-2z'/%3E%3Cpath fill='%23fff' stroke='%232c3e4f' stroke-width='2' d='M12 24a6 6 0 0 0 0-12 6 6 0 0 0 0 12z'/%3E%3Cg fill='%232c3e4f'%3E%3Cpath d='M6 15h12v2H6v-2zm0 4h12v2H6v-2z'/%3E%3Cpath d='M11 12h2v12h-2V12z'/%3E%3C/g%3E%3C/svg%3E")
}

.onfido-sdk-ui-DocumentSelector-DocumentList-icon-national-identity-card {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='-6.5 -12 48 48'%3E%3Cpath fill='%23fff' stroke='%232c3e4f' stroke-width='2' d='M4 1h27a3 3 0 0 1 3 3v16a3 3 0 0 1-3 3H4a3 3 0 0 1-3-3V4a3 3 0 0 1 3-3z'/%3E%3Cpath d='M17 11h8a1 1 0 1 1 0 2h-8a1 1 0 1 1 0-2zm0-4h12a1 1 0 1 1 0 2H17a1 1 0 1 1 0-2z' fill='%232c3e4f'/%3E%3Cpath fill='%23fff' stroke='%232c3e4f' stroke-width='2' d='M5.01 18h8.979a.6.6 0 0 0 .003-.211C13.379 15.538 11.554 14 9.5 14s-3.88 1.539-4.493 3.791A.614.614 0 0 0 5.01 18zm8.964.073zM9.5 11c1.275 0 2.5-1.369 2.5-2.733C12 7.031 10.896 6 9.5 6c-.936 0-1.771.469-2.203 1.195A2.09 2.09 0 0 0 7 8.267C7 9.631 8.225 11 9.5 11z'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-DocumentSelector-DocumentList-icon-driving-licence {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='-6 -15 48 48'%3E%3Cpath fill='%23fff' d='M3.13 16C.97 16 0 12.32 0 9.561 0 7.3.79 5.38 2.34 3.85l-.58-1.17a1 1 0 0 1-.2-1.07c.14-.36.48-.6.85-.6l3.49.55A22.573 22.573 0 0 1 14.29 0c7.59 0 12.64 3.81 13.7 4.69 5.539.15 8.01 4.15 8.01 5.65v3.12c0 1.47-1.439 2.54-2.41 2.54H3.13z'/%3E%3Cg fill='%232c3e4f'%3E%3Cpath d='M11 14h15v2H11v-2zm21.1 2a.95.95 0 0 1-.93-.969v-.012c0-.539.42-1.02.93-1.02h1.49C34 14 34 13.28 34 13v-2.66c0-.63-1.67-3.7-6.35-3.7a.896.896 0 0 1-.61-.24c-.2-.18-5.08-4.44-12.75-4.44-1.35 0-4.83.14-7.89 1.48a.865.865 0 0 1-.35.08L4 3c.06.15.66.82.65.98a1 1 0 0 1-.38.72 5.85 5.85 0 0 0-2.41 4.86c0 3.5 1.15 4.33 1.27 4.479.48.05 1.04.47 1.04.979C4.17 15.29 4 16 4 16h-.87C.97 16 0 12.32 0 9.561 0 7.3.79 5.38 2.34 3.85l-.58-1.17a1 1 0 0 1-.2-1.07c.14-.36.48-.6.85-.6l3.49.55A22.573 22.573 0 0 1 14.29 0c7.59 0 12.64 3.81 13.7 4.69 5.539.15 8.01 4.15 8.01 5.65v3.12c0 1.47-1.439 2.54-2.41 2.54H32.1zM18 4a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0V5a1 1 0 0 1 1-1z'/%3E%3Cpath d='M18 6h5a1 1 0 1 1 0 2h-5a1 1 0 1 1 0-2z'/%3E%3C/g%3E%3Cg fill='%23fff' stroke='%232c3e4f' stroke-width='2'%3E%3Ccircle cx='28.5' cy='13.5' r='3.5'/%3E%3Ccircle cx='7.5' cy='13.5' r='3.5'/%3E%3C/g%3E%3C/svg%3E")
}

.onfido-sdk-ui-DocumentSelector-DocumentList-icon-residence-permit {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' fill='none'%3E%3Cpath d='M8 15a2 2 0 0 1 2-2h29a2 2 0 0 1 2 2v18a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V15z' fill='%23fff' stroke='%232b2d33' stroke-width='2'/%3E%3Cg fill='%232b2d33'%3E%3Crect x='25' y='23' width='8.571' height='2' rx='1'/%3E%3Crect x='25' y='19' width='12' height='2' rx='1'/%3E%3C/g%3E%3Cpath d='m11.75 23.143 4.55-4.457a1 1 0 0 1 1.4 0l4.55 4.457c.64.627.196 1.714-.7 1.714H20.5V29a1 1 0 0 1-1 1h-5a1 1 0 0 1-1-1v-4.143h-1.05c-.896 0-1.34-1.087-.7-1.714z' stroke='%232b2d33' stroke-width='2'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-DocumentSelector-DocumentList-icon-bank-building-society-statement {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48'%3E%3Cdefs%3E%3Cstyle%3E@font-face{font-family:%26quot;OpenSans-Bold%26quot;;src:url(data:application/font-woff;charset=utf-8;base64,) format(%26quot;woff%26quot;);font-weight:700;font-style:normal}.B{stroke:%232c3e4f}.C{stroke-width:2}.D{fill:%232c3e4f}.E{font-family:OpenSans-Bold,Open Sans}.F{font-weight:700}%3C/style%3E%3C/defs%3E%3Cg fill-rule='evenodd'%3E%3Ccircle cx='24' cy='33' r='8' fill='%23fff' class='B C'/%3E%3Ctext font-size='11' class='D E F'%3E%3Ctspan x='20' y='37'%3E€%3C/tspan%3E%3C/text%3E%3Ccircle cx='33' cy='21' r='8' fill='%23fff' class='B C'/%3E%3Ctext font-size='11' class='D E F'%3E%3Ctspan x='30' y='25'%3E£%3C/tspan%3E%3C/text%3E%3Ccircle cx='17' cy='17' r='8' fill='%23fff' class='B C'/%3E%3Ctext font-size='11' class='D E F'%3E%3Ctspan x='14' y='21'%3E$%3C/tspan%3E%3C/text%3E%3C/g%3E%3C/svg%3E")
}

.onfido-sdk-ui-DocumentSelector-DocumentList-icon-utility-bill {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' fill-rule='evenodd'%3E%3Cpath fill='%23fff' stroke='%232c3e4f' stroke-width='2' d='m19.553 28.651.333.223.743 3.343a1 1 0 0 0 .976.783h4.791a1 1 0 0 0 .976-.783l.743-3.343.332-.223A7.99 7.99 0 0 0 32 22a8 8 0 1 0-16 0 7.99 7.99 0 0 0 3.553 6.651z'/%3E%3Cg fill='%232c3e4f'%3E%3Crect width='8' height='2' x='20' y='35' rx='1'/%3E%3Crect width='6' height='2' x='21' y='38' rx='1'/%3E%3Crect width='1' height='4' x='4.268' y='3.768' rx='.5' transform='rotate(-45 19.425 -2.303)'/%3E%3Crect width='1' height='4' x='23' rx='.5' y='8'/%3E%3Crect width='1' height='4' x='22.268' y='3.768' rx='.5' transform='rotate(45 18.111 21.84)'/%3E%3Crect width='4' height='1' y='20' rx='.5' x='10'/%3E%3Crect width='4' height='1' x='34' y='20' rx='.5'/%3E%3C/g%3E%3C/svg%3E")
}
...
.onfido-sdk-ui-DocumentSelector-DocumentList-icon-address-certificate {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='48' height='48' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Crect width='48' height='48' rx='24' fill='%23D5DAE0'/%3E%3Cpath d='M17.802 12.857c5.09 0 9.23 4.105 9.23 9.16.033 6.768-6.75 12.847-9.23 14.84-2.478-1.995-9.263-8.075-9.23-14.848 0-5.047 4.14-9.152 9.23-9.152Z' fill='%23fff' stroke='%232B2D33' stroke-width='1.6' stroke-linejoin='round'/%3E%3Ccircle cx='17.407' cy='21.692' r='3.692' stroke='%232B2D33' stroke-width='1.6'/%3E%3Cpath stroke='%232B2D33' stroke-width='1.7' stroke-linecap='round' d='M29.597 16.293h10.3M29.597 19.721h6.872'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-DocumentSelector-DocumentList-icon-generic-document {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='-4.5 -10 40 40'%3E%3Cpath d='M26.667.833h-22.5a2.5 2.5 0 0 0-2.5 2.5v13.334a2.5 2.5 0 0 0 2.5 2.5h22.5a2.5 2.5 0 0 0 2.5-2.5V3.333a2.5 2.5 0 0 0-2.5-2.5Z' fill='%23fff'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M4.167 1.667c-.92 0-1.667.746-1.667 1.666v13.334c0 .92.746 1.666 1.667 1.666h22.5c.92 0 1.666-.746 1.666-1.666V3.333c0-.92-.746-1.666-1.666-1.666h-22.5ZM.833 3.333A3.333 3.333 0 0 1 4.167 0h22.5A3.333 3.333 0 0 1 30 3.333v13.334A3.333 3.333 0 0 1 26.667 20h-22.5a3.333 3.333 0 0 1-3.334-3.333V3.333Z' fill='%232c3e4f'/%3E%3Cpath d='M22.262 9.167h-5.714c-.395 0-.715.373-.715.833 0 .46.32.833.715.833h5.714c.394 0 .714-.373.714-.833 0-.46-.32-.833-.714-.833ZM25.119 5.833h-8.571c-.395 0-.715.373-.715.834 0 .46.32.833.715.833h8.571c.395 0 .714-.373.714-.833 0-.46-.32-.834-.714-.834Z' fill='%232c3e4f'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M5 6.667a2.5 2.5 0 0 1 2.5-2.5h4.167a2.5 2.5 0 0 1 2.5 2.5v6.666a2.5 2.5 0 0 1-2.5 2.5H7.5a2.5 2.5 0 0 1-2.5-2.5V6.667Zm2.5-.834a.833.833 0 0 0-.833.834v6.666c0 .46.373.834.833.834h4.167c.46 0 .833-.373.833-.834V6.667a.833.833 0 0 0-.833-.834H7.5Z' fill='%232c3e4f'/%3E%3C/svg%3E")
}
...
@media (max-width: 359px) {
  .onfido-sdk-ui-Overlay-face {
    background-position:50% -32.5375em;
...
.onfido-sdk-ui-CameraPermissions-Primer-cameraAllow,.onfido-sdk-ui-CameraPermissions-Primer-microphone {
  background-color: transparent;
  background-position: 50%;
  background-repeat: no-repeat;
  background-size: 100%;
...
[dir=ltr] .onfido-sdk-ui-Error-instruction {
  margin-left: 1.5em
}

[dir=rtl] .onfido-sdk-ui-Error-instruction {
  margin-right: 1.5em
}
...
[dir=ltr] .onfido-sdk-ui-Error-title-text {
  padding-left: 1.5em
}

[dir=rtl] .onfido-sdk-ui-Error-title-text {
  padding-right: 1.5em
}
...
[dir=ltr] .onfido-sdk-ui-Error-title-icon {
  margin-right: .5em
}

[dir=rtl] .onfido-sdk-ui-Error-title-icon {
  margin-left: .5em
}
...
.onfido-sdk-ui-Camera-docLiveCaptureFrame .onfido-sdk-ui-Camera-video {
  object-fit: fill
}
...
.onfido-sdk-ui-FaceVideo-introVideo {
  max-width: 100%;
  width: 300px
}
...
[dir=ltr] .onfido-sdk-ui-FaceVideo-introIcon {
  margin-right: 1.25em
}

[dir=rtl] .onfido-sdk-ui-FaceVideo-introIcon {
  margin-left: 1.25em
}
...
.onfido-sdk-ui-FaceVideo-stopRecording {
  background-color: transparent;
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='56' height='56' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Ccircle stroke='%23FFF' stroke-width='4' cx='28' cy='28' r='26'/%3E%3Crect fill='%23DC2A2A' x='16' y='16' width='24' height='24' rx='3'/%3E%3C/g%3E%3C/svg%3E");
  background-repeat: no-repeat;
  background-size: contain;
  border: 0;
  box-shadow: none;
...
.onfido-sdk-ui-Capture-IdTypeSelector-idTypeSelector .ods-select,.onfido-sdk-ui-Capture-StateSelector-stateSelector .ods-select {
  max-width: none
}
...
.onfido-sdk-ui-PhoneNumberInput-phoneNumberContainer .PhoneInputCountrySelectArrow {
  margin: 0 8px
}
...
.onfido-sdk-ui-PhoneNumberInput-phoneNumberContainer button:focus,.onfido-sdk-ui-PhoneNumberInput-phoneNumberContainer input:focus {
  ...
  outline: auto 5px var(--osdk-color-input-outline)
}

.onfido-sdk-ui-UserConsent-consent {
  background: #f7f9fa;
...
.onfido-sdk-ui-UserConsent-header {
  align-items: flex-start;
  display: flex;
  gap: 6px
}

.onfido-sdk-ui-UserConsent-title {
  flex-grow: 1
}

.onfido-sdk-ui-UserConsent-header>button {
  background: #d5dae0;
...
.onfido-sdk-ui-UserConsent-content {
  margin: 8px 48px 16px
}

.onfido-sdk-ui-CaptureViewer-pdfIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='64' height='64' xml:space='preserve'%3E%3Cpath fill='%23FFF' d='M17 55c-1.1 0-2-.9-2-2V11c0-1.1.9-2 2-2h24.4l7.6 8.4V53c0 1.1-.9 2-2 2H17z'/%3E%3Cpath fill='%232C3E4F' d='m40.9 10 7.1 7.8V53c0 .5-.5 1-1 1H17c-.5 0-1-.5-1-1V11c0-.5.5-1 1-1h23.9m.9-2H17c-1.7 0-3 1.4-3 3v42c0 1.6 1.3 3 3 3h30c1.7 0 3-1.4 3-3V17l-8.2-9z'/%3E%3Cpath fill='none' stroke='%232C3E4F' stroke-width='2' stroke-miterlimit='10' d='M48 18h-5c-1.1 0-2-.9-2-2v-6'/%3E%3Cpath fill='%23F5272E' d='M53 48H28c-.5 0-1-.5-1-1V37c0-.5.5-1 1-1h25c.5 0 1 .5 1 1v10c0 .5-.5 1-1 1z'/%3E%3Cg fill='%23FFF'%3E%3Cpath d='M35.7 40.4c0 .8-.3 1.5-.9 1.9-.6.4-1.4.7-2.5.7h-.9v3H30v-8h2.5c1.1 0 1.9.2 2.4.6.5.4.8 1 .8 1.8zm-4.3 1.5h.7c.7 0 1.2-.1 1.6-.4.3-.2.5-.6.5-1.1 0-.5-.1-.8-.5-1-.3-.2-.8-.3-1.4-.3h-1v2.8zM44 41.9c0 1.3-.4 2.3-1.2 3-.8.7-1.9 1-3.4 1H37v-8h2.6c1.4 0 2.4.3 3.2 1 .8.8 1.2 1.8 1.2 3zm-1.5.1c0-1.9-1-2.9-2.9-2.9h-1.2v5.8h1c2.1 0 3.1-1 3.1-2.9zM47.4 46H46v-8h5v1.1h-3.6v2.5h3.3v1.1h-3.3V46z'/%3E%3C/g%3E%3Ccircle fill='%232C3E4F' cx='16' cy='11' r='7'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' fill='%23FFF' d='m18.1 8.5-2.9 3.1-.7-.8c-.3-.3-.8-.3-1.2 0-.3.3-.3.9 0 1.2l1.3 1.4c.3.3.8.3 1.2 0l3.5-3.7c.3-.3.3-.9 0-1.2-.4-.3-.9-.3-1.2 0z'/%3E%3C/svg%3E");
  background-position: 50% 50%;
  background-repeat: no-repeat;
  display: inline-block;
  height: 11.25em;
...
.onfido-sdk-ui-CaptureViewer-croppedImageWrapper,.onfido-sdk-ui-CaptureViewer-imageWrapper,.onfido-sdk-ui-CaptureViewer-pdfWrapper,.onfido-sdk-ui-CaptureViewer-videoWrapper {
  display: flex;
  justify-content: center;
  min-height: 5.625em;
  position: relative
...
.onfido-sdk-ui-CaptureViewer-croppedImageWrapper.onfido-sdk-ui-CaptureViewer-fullscreenImageWrapper,.onfido-sdk-ui-CaptureViewer-imageWrapper.onfido-sdk-ui-CaptureViewer-fullscreenImageWrapper {
  position: static
}
...
.onfido-sdk-ui-EnlargedPreview-expanded,.onfido-sdk-ui-EnlargedPreview-imageContainer {
  height: 100%;
  left: 0;
  position: absolute;
  top: 0;
...
[dir=ltr] .onfido-sdk-ui-EnlargedPreview-enlargeIcon {
  margin-right: .625em
}

[dir=rtl] .onfido-sdk-ui-EnlargedPreview-enlargeIcon {
  margin-left: .625em
}

.onfido-sdk-ui-EnlargedPreview-enlargeIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='12' height='12' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Cdefs%3E%3Cpath d='M1.24 3.33h3.1V2H.63C.28 2 0 2.3 0 2.67v4h1.24V3.33zM.62 14h3.73v-1.33h-3.1V9.33H0v4c0 .37.28.67.62.67zM12 13.33v-4h-1.25v3.34h-3.1V14h3.73c.34 0 .62-.3.62-.67zm-4.35-10h3.1v3.34H12v-4c0-.37-.28-.67-.62-.67H7.65v1.33z' id='a'/%3E%3C/defs%3E%3Cuse fill='%23FFF' xlink:href='%23a' transform='translate(0 -2)' opacity='.85'/%3E%3C/svg%3E");
  background-repeat: no-repeat;
  background-size: contain;
  display: inline-block;
  height: .75em;
...
[dir=ltr] .onfido-sdk-ui-EnlargedPreview-collapseIcon {
  margin-right: .625em
}

[dir=rtl] .onfido-sdk-ui-EnlargedPreview-collapseIcon {
  margin-left: .625em
}

.onfido-sdk-ui-EnlargedPreview-collapseIcon {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='12' height='12' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Cdefs%3E%3Cpath d='m.943 13.471 2.114-2.114 1.414 1.414V9H.701l1.414 1.414L0 12.529l.943.942zM11.029 2 8.914 4.115 7.5 2.7v3.77h3.77L9.858 5.057l2.114-2.114L11.03 2zM7.5 9v3.77l1.414-1.413 2.115 2.114.942-.942-2.114-2.115L11.27 9H7.5zM4.471 2.7 3.057 4.116.943 2 0 2.943l2.115 2.114L.7 6.471h3.77v-3.77z' id='a'/%3E%3C/defs%3E%3Cuse fill='%23FFF' xlink:href='%23a' transform='translate(0 -2)' opacity='.85'/%3E%3C/svg%3E");
  background-repeat: no-repeat;
  background-size: contain;
  display: inline-block;
  height: .875em;
...
[dir=ltr] .onfido-sdk-ui-Confirm-retakeAction.onfido-sdk-ui-Confirm-vertical {
  margin-right: 0
}

[dir=rtl] .onfido-sdk-ui-Confirm-retakeAction.onfido-sdk-ui-Confirm-vertical {
  margin-left: 0
}
...
.onfido-sdk-ui-Confirm-fullscreen {
  overflow: visible;
  overflow: initial
}
...
.onfido-sdk-ui-crossDevice-MobileConnected-icon {
  background-color: #e9ecf0;
  background-color: var(--osdk-color-background-icon);
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height='144' fill='none'%3E%3Cpath d='M120.953 30H50.476a7.05 7.05 0 0 0-7.048 7.048v42.286a7.05 7.05 0 0 0 7.048 7.048h70.477A7.05 7.05 0 0 0 128 79.333V37.048A7.05 7.05 0 0 0 120.953 30z' fill='%23fff'/%3E%3Cg fill='%232b2d33'%3E%3Cpath d='M50.476 33.524a3.524 3.524 0 0 0-3.524 3.524v42.286a3.524 3.524 0 0 0 3.524 3.524h70.477a3.523 3.523 0 0 0 3.523-3.524V37.048a3.523 3.523 0 0 0-3.523-3.524H50.476zm0-3.524h70.477A7.05 7.05 0 0 1 128 37.048v42.286a7.05 7.05 0 0 1-7.047 7.048H50.476a7.05 7.05 0 0 1-7.048-7.048V37.048A7.05 7.05 0 0 1 50.476 30zm54.62 63.429H66.334a1.762 1.762 0 1 0 0 3.524h38.762a1.762 1.762 0 1 0 0-3.524z'/%3E%3Cpath fill-rule='evenodd' d='M65.453 77.572h40.524a.88.88 0 1 1 0 1.762H65.453a.88.88 0 1 1 0-1.762z'/%3E%3Cpath d='M87.476 84.619a1.76 1.76 0 1 0-3.524 0V95.19a1.76 1.76 0 1 0 3.524 0V84.619z'/%3E%3C/g%3E%3Cg fill='%23fff' stroke='%232b2d33'%3E%3Cpath d='M48.714 47.619H24.048A7.05 7.05 0 0 0 17 54.667v52.857a7.05 7.05 0 0 0 7.048 7.048h24.667a7.05 7.05 0 0 0 7.048-7.048V54.667a7.05 7.05 0 0 0-7.048-7.048z' stroke-width='3.524'/%3E%3Cpath d='M36.381 110.167a3.524 3.524 0 1 0 0-7.049 3.524 3.524 0 0 0 0 7.049z' stroke-width='1.762'/%3E%3C/g%3E%3Cg fill='%232b2d33'%3E%3Cpath d='M43.428 52.905H29.333a.88.88 0 1 0 0 1.762h14.095a.88.88 0 1 0 0-1.762z'/%3E%3Cpath fill-rule='evenodd' d='M48 16a2.01 2.01 0 0 1 2.02-2c1.1 0 1.98.9 1.98 2s-.88 2-1.98 2A2.01 2.01 0 0 1 48 16zm8 0c0-1.1.9-2 2-2 1.12 0 2 .9 2 2s-.88 2-2 2c-1.1 0-2-.9-2-2zm8 0c0-1.1.88-2 1.98-2A2.01 2.01 0 0 1 68 16a2.01 2.01 0 0 1-2.02 2c-1.1 0-1.98-.9-1.98-2zm8 0c0-1.1.9-2 2-2 1.12 0 2 .9 2 2s-.88 2-2 2c-1.1 0-2-.9-2-2zm8 0a2.01 2.01 0 0 1 2.02-2c1.1 0 1.98.9 1.98 2s-.88 2-1.98 2A2.01 2.01 0 0 1 80 16zm8 0c0-1.1.9-2 2-2 1.12 0 2 .9 2 2s-.88 2-2 2c-1.1 0-2-.9-2-2zm-47.98.142c-.02-.04-.02-.1-.02-.16a2.034 2.034 0 0 1 1.88-1.977c1.1-.08 2.04.759 2.12 1.858v.16c0 1.039-.8 1.898-1.84 1.977h-.14c-1.06 0-1.94-.799-2-1.858zM95.398 20.2A2.07 2.07 0 0 1 95 18.999c0-.6.28-1.201.8-1.601.88-.66 2.14-.48 2.8.4.28.36.4.78.4 1.201 0 .62-.28 1.221-.8 1.601-.36.28-.78.4-1.2.4a2.03 2.03 0 0 1-1.602-.8zM35.04 21.76a2.023 2.023 0 0 1-.8-2.726 1.999 1.999 0 0 1 2.72-.782 2 2 0 0 1 .8 2.706h-.02A1.948 1.948 0 0 1 36 22c-.32 0-.66-.08-.96-.241zM97 27c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm-64 1c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm0 8c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2zm0 8c0-1.1.9-2 2-2s2 .9 2 2-.9 2-2 2-2-.9-2-2z'/%3E%3C/g%3E%3C/svg%3E");
  background-size: contain;
  border-radius: 50%;
  height: 9em;
  margin: 1.5em auto .625em;
  width: 9em
}

.onfido-sdk-ui-crossDevice-MobileConnected-help {
  width: 100%
}
...
.onfido-sdk-ui-crossDevice-MobileConnected-header {
  margin-top: 0;
  position: relative;
  top: 1em;
  z-index: 1
...
.onfido-sdk-ui-crossDevice-MobileConnected-content {
  align-items: flex-start;
  display: flex;
  flex-direction: column;
  flex-grow: 1;
...
[dir=ltr] .onfido-sdk-ui-crossDevice-CrossDeviceSubmit-icon {
  margin-right: .875em
}

[dir=rtl] .onfido-sdk-ui-crossDevice-CrossDeviceSubmit-icon {
  margin-left: .875em
}
...
.onfido-sdk-ui-crossDevice-MobileNotificationSent-icon {
  background-color: #e9ecf0;
  background-color: var(--osdk-color-background-icon);
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='144' height='144' fill='none'%3E%3Cg fill='%23f7f9fa' stroke='%231e1e24'%3E%3Cpath d='M93.869 25.884H48.093a7.042 7.042 0 0 0-7.042 7.042v88.031a7.042 7.042 0 0 0 7.042 7.042h45.776a7.042 7.042 0 0 0 7.042-7.042v-88.03a7.042 7.042 0 0 0-7.042-7.042z' stroke-width='3.521'/%3E%3Cpath d='M70.981 120.958a4.402 4.402 0 0 0 4.402-4.402 4.4 4.4 0 1 0-8.803 0 4.402 4.402 0 0 0 4.401 4.402z' stroke-width='1.761'/%3E%3C/g%3E%3Cg fill='%231e1e24'%3E%3Cpath d='M81.985 32.927H59.977a1.32 1.32 0 1 0 0 2.641h22.008a1.32 1.32 0 1 0 0-2.641z'/%3E%3Cpath d='M106.633 26.764h6.163a1.321 1.321 0 1 1 0 2.641h-6.163a1.32 1.32 0 1 1 0-2.641zm-5.281-11.443v6.162a1.321 1.321 0 0 1-2.641 0v-6.162a1.321 1.321 0 0 1 2.641 0zm3.134 6.171 4.357-4.357a1.321 1.321 0 1 1 1.868 1.867l-4.358 4.357a1.32 1.32 0 1 1-1.867-1.867z' fill-rule='evenodd'/%3E%3C/g%3E%3Cpath d='M93.429 56.255H48.533a1.76 1.76 0 0 0-1.761 1.761v9.683a1.76 1.76 0 0 0 1.761 1.761h44.896a1.76 1.76 0 0 0 1.761-1.761v-9.683a1.76 1.76 0 0 0-1.761-1.761z' fill='%23f7f9fa' stroke='%23a2a8b3' stroke-width='.88'/%3E%3Cg fill-rule='evenodd'%3E%3Cpath d='M51.614 62.857a1.76 1.76 0 1 0 0-3.521 1.76 1.76 0 1 0 0 3.521z' fill='%234fb312'/%3E%3Cpath d='M56.896 60.216h25.529a.881.881 0 1 1 0 1.761H56.896a.881.881 0 1 1 0-1.761zm-.44 4.402h33.452a.44.44 0 1 1 0 .88H56.456a.44.44 0 1 1 0-.88z' fill='%23a2a8b3'/%3E%3C/g%3E%3C/svg%3E");
  background-size: contain;
  border-radius: 50%;
  height: 9em;
  margin-bottom: 2em;
...
[dir=rtl] .onfido-sdk-ui-crossDevice-CrossDeviceLink-optionIcon {
  transform: scaleX(-1)
}
...
[dir=ltr] .onfido-sdk-ui-crossDevice-CrossDeviceLink-inputContainer {
  border-top-left-radius: .25em
}

[dir=rtl] .onfido-sdk-ui-crossDevice-CrossDeviceLink-inputContainer {
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-inputContainer {
  ...
  border: 1px solid #828893;
  border: 1px solid rgba(var(--ods-color-border-input));
  box-shadow: 0 -.00625em 0 0 #828893;
  box-shadow: 0 -.00625em 0 0 rgba(var(--ods-color-border-input));
  display: flex;
  height: 100%
}

.onfido-sdk-ui-crossDevice-CrossDeviceLink-inputContainer form {
  width: 100%
}
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-fieldError {
  ...
  box-shadow: 0 -.00625em 0 0 #c32f2f;
  box-shadow: 0 -.00625em 0 0 rgba(var(--ods-color-content-negative))
}
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-iconCheckmark {
  content: "";
  display: inline-block;
  height: .6875em;
  justify-content: center;
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-numberInputSection .onfido-sdk-ui-crossDevice-CrossDeviceLink-btn {
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-styledLabel:after,.onfido-sdk-ui-crossDevice-CrossDeviceLink-styledLabel:before {
  border: 1px solid #b4bac5;
  border: 1px solid rgb(var(--ods-color-neutral-400));
  content: "";
  flex: 1 0 1.125em
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-styledLabelText {
  margin: 0 1.125em
}
...
.onfido-sdk-ui-crossDevice-CrossDeviceLink-optionIcon {
  background-repeat: no-repeat;
  content: "";
  display: inline-block;
  height: 1em;
...
[dir=rtl] .onfido-sdk-ui-QRCode-qrCodeHelpIcon {
  transform: scaleX(-1)
}
...
.onfido-sdk-ui-crossDevice-ClientSuccess-icon {
  background-color: #e9ecf0;
  background-color: var(--osdk-color-background-icon);
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='144' height='144' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M52.286 26h-23.75a6.786 6.786 0 0 0-6.786 6.786v50.893a6.786 6.786 0 0 0 6.786 6.785h23.75a6.786 6.786 0 0 0 6.785-6.785V32.786A6.786 6.786 0 0 0 52.286 26z' fill='%23fff' stroke='%232B2D33' stroke-width='3.393'/%3E%3Cpath d='M40.41 86.223a3.393 3.393 0 1 0 0-6.785 3.393 3.393 0 0 0 0 6.785z' fill='%23fff' stroke='%232B2D33' stroke-width='1.696'/%3E%3Cpath d='M47.196 31.09H33.625a.848.848 0 1 0 0 1.696h13.571a.848.848 0 1 0 0-1.697z' fill='%232B2D33'/%3E%3Cpath d='M40.411 67.563c5.621 0 10.179-4.558 10.179-10.18 0-5.62-4.558-10.178-10.179-10.178-5.622 0-10.179 4.557-10.179 10.179 0 5.621 4.557 10.178 10.179 10.178z' fill='%233640F5'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='m43.945 53.581-4.977 5.282-1.244-1.32a1.354 1.354 0 0 0-1.99 0 1.56 1.56 0 0 0 0 2.113l2.24 2.379a1.35 1.35 0 0 0 1.99 0l5.972-6.34a1.56 1.56 0 0 0 0-2.114 1.348 1.348 0 0 0-1.99 0z' fill='%23F7F9FA'/%3E%3Cpath d='M121.839 56.536H53.982a6.786 6.786 0 0 0-6.786 6.785v40.715a6.786 6.786 0 0 0 6.786 6.785h67.857a6.786 6.786 0 0 0 6.786-6.785V63.321a6.786 6.786 0 0 0-6.786-6.785z' fill='%23fff'/%3E%3Cpath d='M53.982 59.928a3.393 3.393 0 0 0-3.393 3.393v40.715a3.394 3.394 0 0 0 3.393 3.393h67.857a3.394 3.394 0 0 0 3.393-3.393V63.321a3.393 3.393 0 0 0-3.393-3.392H53.982zm0-3.392h67.857a6.786 6.786 0 0 1 6.786 6.785v40.715a6.786 6.786 0 0 1-6.786 6.785H53.982a6.786 6.786 0 0 1-6.786-6.785V63.321a6.786 6.786 0 0 1 6.786-6.785zm52.59 61.071H69.25a1.697 1.697 0 0 0 0 3.393h37.322a1.696 1.696 0 0 0 0-3.393z' fill='%232B2D33'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M68.402 102.339h39.018a.848.848 0 0 1 0 1.697H68.402a.849.849 0 0 1 0-1.697z' fill='%232B2D33'/%3E%3Cpath d='M89.607 109.125a1.697 1.697 0 1 0-3.393 0v10.178a1.697 1.697 0 1 0 3.393 0v-10.178z' fill='%232B2D33'/%3E%3Cpath d='M75.293 66.183c2.004-7.956-2.768-16.222-10.66-18.463-3.947-1.121-7.926-.524-11.168 1.349' stroke='%232B2D33' stroke-width='2.545' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cpath d='m78.824 66.166-4.407 2.545-2.545-4.408' stroke='%232B2D33' stroke-width='2.545' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E");
...
[dir=ltr] .onfido-sdk-ui-crossDevice-Intro-stage:before {
  margin-left: 1.4375em
}

[dir=rtl] .onfido-sdk-ui-crossDevice-Intro-stage:before {
  margin-right: 1.4375em
}
...
.onfido-sdk-ui-crossDevice-Intro-stageIcon-sms {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' fill='none'%3E%3Cg fill='%23f7f9fa' stroke='%231e1e24'%3E%3Crect x='13.886' y='8.432' width='19.5' height='33.682' rx='2.659' stroke-width='1.773'/%3E%3Cpath d='M24.966 38.568a1.33 1.33 0 0 1-1.329 1.33 1.33 1.33 0 0 1-1.33-1.33 1.33 1.33 0 0 1 1.33-1.33 1.33 1.33 0 0 1 1.329 1.33z' stroke-width='.886'/%3E%3C/g%3E%3Crect x='34.273' y='6.767' width='2.659' height='.886' rx='.443' transform='rotate(315 34.273 6.767)' fill='%231e1e24'/%3E%3Cmask id='a' fill='%23fff'%3E%3Crect x='15.659' y='18.182' width='15.955' height='6.205' rx='.591'/%3E%3C/mask%3E%3Crect x='15.659' y='18.182' width='15.955' height='6.205' rx='.591' fill='%23f7f9fa' stroke='%23a2a8b3' stroke-width='1.773' mask='url(%23a)'/%3E%3Cg fill-rule='evenodd'%3E%3Cpath d='M20.977 21.284c0-.245.198-.443.443-.443h7.977a.443.443 0 1 1 0 .886H21.42a.443.443 0 0 1-.443-.443z' fill='%23a2a8b3'/%3E%3Cpath d='M18.761 22.614a1.33 1.33 0 0 0 1.33-1.33 1.33 1.33 0 0 0-1.33-1.329 1.33 1.33 0 0 0-1.329 1.329 1.33 1.33 0 0 0 1.329 1.33z' fill='%233640f5'/%3E%3C/g%3E%3Cg fill='%231e1e24'%3E%3Crect x='20.091' y='10.205' width='7.091' height='.886' rx='.443'/%3E%3Crect x='35.159' y='7.545' width='2.659' height='.886' rx='.443'/%3E%3Crect x='32.943' y='4' width='.886' height='2.659' rx='.443'/%3E%3C/g%3E%3C/svg%3E")
}

.onfido-sdk-ui-crossDevice-Intro-stageIcon-take-photos {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' fill='none' fill-rule='evenodd'%3E%3Crect stroke='%232c3e4f' stroke-width='1.333' fill='%23fff' x='15.334' y='8.667' width='17.333' height='30.667' rx='2.667'/%3E%3Crect fill='%232c3e4f' x='20.667' y='10.667' width='6.667' height='1' rx='.5'/%3E%3Cg fill='%23fff' stroke-width='.667'%3E%3Ccircle stroke='%232c3e4f' cx='24' cy='36.667' r='1'/%3E%3Cpath d='M6.708 20.165A1 1 0 0 0 6 21.39l2.761 10.303a1 1 0 0 0 1.225.707l18.031-4.831a1 1 0 0 0 .707-1.225l-2.761-10.303a1 1 0 0 0-1.225-.707l-18.03 4.831z' stroke='%23283e4f'/%3E%3C/g%3E%3Cg fill='%23283e4f'%3E%3Cg transform='rotate(345 86.665 -52.339)'%3E%3Crect y='4' width='6' height='1' rx='.5'/%3E%3Crect y='2' width='8.667' height='1' rx='.5'/%3E%3Crect width='8.667' height='1' rx='.5'/%3E%3C/g%3E%3Cpath d='M13.054 28.472c1.198-.321 2.821.362 3.929 1.708l.644-.172c-1.281-1.717-3.081-2.625-4.745-2.18-1.638.439-2.708 2.171-2.982 4.25l.644-.172c.308-1.712 1.365-3.127 2.511-3.433z' fill-rule='nonzero'/%3E%3C/g%3E%3Cpath d='M12.964 26.771c1.339-.359 2.165-2.225 1.742-3.803-.398-1.484-1.875-2.373-3.295-1.993-.944.253-1.656 1.016-1.882 1.982a2.85 2.85 0 0 0 .025 1.391c.423 1.577 2.07 2.781 3.41 2.422z' stroke='%23283e4f' stroke-width='.667'/%3E%3Cpath fill='%23283e4f' d='M14.667 16H16v20.667h-1.333z'/%3E%3Cpath fill-opacity='.67' fill='%23fff' d='M16 14.667h16v18H16z'/%3E%3Cpath stroke='%23fff' stroke-width='.667' d='M16.333 14.333h15.333v17.333H16.333z'/%3E%3C/svg%3E")
}

.onfido-sdk-ui-crossDevice-Intro-stageIcon-take-selfie {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg width='49' height='48' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cg clip-path='url(%23a)'%3E%3Crect x='13.925' y='6.925' width='20.35' height='35.15' rx='2.775' fill='%23F7F9FA' stroke='%231E1E24' stroke-width='1.85'/%3E%3Cpath d='M25.488 38.375a1.387 1.387 0 1 1-2.775 0 1.387 1.387 0 0 1 2.774 0zm5.55-15.725a6.938 6.938 0 1 1-13.876 0 6.938 6.938 0 0 1 13.876 0z' fill='%23F7F9FA' stroke='%231E1E24' stroke-width='.925'/%3E%3Crect x='20.4' y='8.775' width='7.4' height='.925' rx='.463' fill='%231E1E24'/%3E%3Cpath d='M31.054 20.114a6.013 6.013 0 0 1-8.765-4.64 7.36 7.36 0 0 0-1.02.337 6.015 6.015 0 0 1-4.567 6.678 7.21 7.21 0 0 0 .038.939 6.946 6.946 0 0 0 5.375-5.422 6.937 6.937 0 0 0 6.148 3.719 6.91 6.91 0 0 0 3.056-.708 7.35 7.35 0 0 0-.265-.903z' fill='%231E1E24'/%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M25.95 24.5a.925.925 0 1 0 0-1.85.925.925 0 0 0 0 1.85zm-3.7 0a.925.925 0 1 0 0-1.85.925.925 0 0 0 0 1.85z' fill='%231E1E24'/%3E%3C/g%3E%3Cdefs%3E%3CclipPath id='a'%3E%3Cpath fill='%23fff' transform='translate(.5)' d='M0 0h48v48H0z'/%3E%3C/clipPath%3E%3C/defs%3E%3C/svg%3E")
}

.onfido-sdk-ui-crossDevice-Intro-stageIcon-return-to-computer {
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='48' height='48' fill='none'%3E%3Cg fill='%231e1e24'%3E%3Crect x='22.564' y='40.256' width='13.949' height='1.744' rx='.872'/%3E%3Crect x='28.667' y='36.769' width='1.744' height='4.359' rx='.872'/%3E%3C/g%3E%3Cg fill='%23f7f9fa' stroke='%231e1e24'%3E%3Crect x='6.872' y='8.872' width='12.205' height='20.923' rx='1.744' stroke-width='1.744'/%3E%3Cpath d='M13.41 26.744a.87.87 0 1 1-1.744 0 .87.87 0 1 1 1.744 0z' stroke-width='.872'/%3E%3Cpath d='M17.65 20.205c-.657 0-1.189.53-1.189 1.183v14.198c0 .654.532 1.183 1.189 1.183h23.776c.657 0 1.189-.53 1.189-1.183V21.388c0-.653-.532-1.183-1.189-1.183H17.65z' stroke-width='1.744'/%3E%3C/g%3E%3Cg fill-rule='evenodd'%3E%3Cpath d='M22.564 34.59c0-.241.195-.436.436-.436h13.077a.436.436 0 1 1 0 .872H23a.436.436 0 0 1-.436-.436z' fill='%231e1e24'/%3E%3Cpath d='M12.975 21.949a3.49 3.49 0 0 0 3.487-3.487 3.49 3.49 0 0 0-3.487-3.487 3.49 3.49 0 0 0-3.487 3.487 3.49 3.49 0 0 0 3.487 3.487z' fill='%233640f5'/%3E%3Cpath d='m13.958 16.882-1.574 1.974-.393-.493c-.174-.217-.456-.217-.63 0s-.174.573 0 .79l.708.889c.174.218.456.218.63 0l1.889-2.369a.663.663 0 0 0 0-.79.38.38 0 0 0-.63 0z' fill='%23f7f9fa'/%3E%3C/g%3E%3Crect x='10.359' y='10.616' width='5.231' height='.872' rx='.436' fill='%231e1e24'/%3E%3C/svg%3E")
}

[dir=ltr] .onfido-sdk-ui-crossDevice-Intro-stageMessage {
  margin-left: .9375em
}

[dir=rtl] .onfido-sdk-ui-crossDevice-Intro-stageMessage {
  margin-right: .9375em
}
...
.onfido-sdk-ui-crossDevice-Intro-stageMessage-return-to-computer,.onfido-sdk-ui-crossDevice-Intro-stageMessage-sms,.onfido-sdk-ui-crossDevice-Intro-stageMessage-take-photos {
  color: #2b2d33;
  color: var(--osdk-color-content-body)
}

.onfido-sdk-ui-IntroVideo-introVideo {
  font-size: 0;
  margin: 0 auto;
  position: relative
}

.onfido-sdk-ui-IntroVideo-videoWrapper {
  background: none;
  border: 0;
  border-radius: 0;
  font-size: 0;
...
.onfido-sdk-ui-IntroVideo-videoWrapper:active {
  background: none;
  box-shadow: none
}

.onfido-sdk-ui-IntroVideo-videoWrapper:focus,.onfido-sdk-ui-IntroVideo-videoWrapper:focus-visible {
  border-radius: 2px;
  border-radius: var(--ods-border-radius-small);
  outline: 2px solid #232aad;
  outline: 2px solid var(--osdk-color-border-button-primary-active);
  outline-offset: -1px
}

.onfido-sdk-ui-IntroVideo-video {
  max-width: 100%;
  width: 100%
}

.onfido-sdk-ui-IntroVideo-video:focus,.onfido-sdk-ui-IntroVideo-video:focus-visible {
  outline: 0
}
...
.onfido-sdk-ui-IntroVideo-button svg {
  height: 40px;
  width: 40px
}

.onfido-sdk-ui-ActiveVideo-Intro-intro {
  align-items: center;
  display: flex;
  flex-direction: column;
  width: 100%
...
.onfido-sdk-ui-ActiveVideo-Intro-introVideo {
  height: 140px;
  min-height: 140px;
  min-width: 140px;
  width: 140px
...
.onfido-sdk-ui-ActiveVideo-Intro-wrapperBody {
...
[dir=ltr] .onfido-sdk-ui-ActiveVideo-Intro-list .onfido-sdk-ui-ActiveVideo-Intro-listItem .onfido-sdk-ui-ActiveVideo-Intro-text:before {
  margin-right: 16px
}

[dir=rtl] .onfido-sdk-ui-ActiveVideo-Intro-list .onfido-sdk-ui-ActiveVideo-Intro-listItem .onfido-sdk-ui-ActiveVideo-Intro-text:before {
  margin-left: 16px
}
...
.onfido-sdk-ui-ActiveVideo-Disclaimer-disclaimer {
  align-items: center;
  background: #ebedff;
  background: rgba(var(--ods-color-primary-100),1);
  border-radius: 8px;
  border-radius: var(--ods-border-radius-large);
  display: flex;
  margin-bottom: 16px;
...
[dir=ltr] .onfido-sdk-ui-ActiveVideo-Disclaimer-disclaimer svg {
  margin-right: 12px
}

[dir=rtl] .onfido-sdk-ui-ActiveVideo-Disclaimer-disclaimer svg {
  margin-left: 12px
}

.onfido-sdk-ui-ActiveVideo-Disclaimer-disclaimer svg {
  fill: #3640f5;
  fill: rgba(var(--ods-color-primary-500),1);
  min-width: 24px
}

.onfido-sdk-ui-ActiveVideo-Disclaimer-disclaimer .onfido-sdk-ui-ActiveVideo-Disclaimer-text {
  color: #2b2d33;
  color: rgba(var(--ods-color-neutral-800),1);
  font-family: inherit;
  font-size: .875rem;
  font-weight: 400;
  line-height: 1.5rem;
...
.onfido-sdk-ui-ActiveVideo-RecordingComplete-wrapperBody,.onfido-sdk-ui-ActiveVideo-Uploading-wrapperBody {
  align-items: center;
  display: flex;
  flex-direction: column;
  justify-content: center
...
.onfido-sdk-ui-ActiveVideo-ConnectionError-vertical {
  align-items: center;
  display: flex;
  flex-direction: column;
  row-gap: 8px
...
[dir=ltr] .onfido-sdk-ui-ProofOfAddress-PoAIntro-list {
  padding-left: 1em
}

[dir=rtl] .onfido-sdk-ui-ProofOfAddress-PoAIntro-list {
  padding-right: 1em
}
...
.onfido-sdk-ui-ProofOfAddress-PoAIntro-requirement::marker {
  color: #3640f5;
  color: var(--osdk-color-background-alert-info)
}
...
[dir=ltr] .onfido-sdk-ui-ProofOfAddress-Guidance-warningSmallIcon {
  margin-right: .3571428571em
}

[dir=rtl] .onfido-sdk-ui-ProofOfAddress-Guidance-warningSmallIcon {
  margin-left: .3571428571em
}

.onfido-sdk-ui-ProofOfAddress-Guidance-warningSmallIcon {
  display: inline-block;
...
[dir=ltr] .onfido-sdk-ui-ProofOfAddress-Guidance-list {
  padding-left: 1em
}

[dir=rtl] .onfido-sdk-ui-ProofOfAddress-Guidance-list {
  padding-right: 1em
}

.onfido-sdk-ui-ProofOfAddress-Guidance-list {
  margin: 0;
  padding: 0;
  text-align: left;
  text-align: initial
...
.onfido-sdk-ui-ProofOfAddress-Guidance-requirement::marker {
  color: #3640f5;
  color: var(--osdk-color-background-alert-info)
}
...
[dir=ltr] .onfido-sdk-ui-CountrySelector-icon {
  margin-right: .5em
}

[dir=rtl] .onfido-sdk-ui-CountrySelector-icon {
  margin-left: .5em
}

.onfido-sdk-ui-CountrySelector-icon {
  display: inline-block;
  height: .8125em;
  width: .8125em
}

.onfido-sdk-ui-CountrySelector-CountryDropdown-listItem {
  display: flex
}
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-countryFlagLabel,.onfido-sdk-ui-CountrySelector-CountryDropdown-countryLabel {
  align-items: center;
  display: flex
}

[dir=ltr] .onfido-sdk-ui-CountrySelector-CountryDropdown-countryFlagLabel {
  padding-left: .5em
}

[dir=rtl] .onfido-sdk-ui-CountrySelector-CountryDropdown-countryFlagLabel {
  padding-right: .5em
}

.onfido-sdk-ui-CountrySelector-CountryDropdown-dropdownIcon {
  background-color: transparent;
  background-image: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='none'%3E%3Cpath fill-rule='evenodd' d='M10 18a7.95 7.95 0 0 0 4.897-1.688l4.396 4.396 1.414-1.414-4.396-4.396A7.95 7.95 0 0 0 18 10a8.01 8.01 0 0 0-8-8 8.01 8.01 0 0 0-8 8 8.01 8.01 0 0 0 8 8zm0-14a6.01 6.01 0 0 1 6 6 6.01 6.01 0 0 1-6 6 6.01 6.01 0 0 1-6-6 6.01 6.01 0 0 1 6-6z' fill='%23636670'/%3E%3C/svg%3E");
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-custom__input {
  ...
  outline-color: var(--osdk-color-input-outline);
  position: relative
}
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-chevronIcon,.onfido-sdk-ui-CountrySelector-CountryDropdown-dropdownIcon {
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-custom__menu {
  background-color: #fff;
  background-color: var(--osdk-color-background-selector);
  border: 1px solid #828893;
  border: 1px solid rgba(var(--ods-color-border-input));
  border-top: 0;
  color: #2b2d33;
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-custom__menu--overlay {
  box-shadow: 0 .125em .375em rgba(0,0,0,.257);
  left: .125em;
  position: absolute;
  top: 100%;
  z-index: 100
...
.onfido-sdk-ui-CountrySelector-CountryDropdown-custom__option--focused,.onfido-sdk-ui-CountrySelector-CountryDropdown-custom__option:hover {
  ...
  color: 255,255,255;
  color: var(--ods-color-neutral-white);
  outline: none
}
...
.onfido-sdk-ui-RestrictedDocumentSelection-disabledInput {
  height: 2.375em
}
...
[direction=rtl] .kyc .ant-select-selection-item {
  padding-right: 0
}

.kyc .ant-form-item-explain-error {
  color: var(--ds-color-function-error);
  font-size: 11px!important;
  margin-bottom: 16px;
  margin-top: 8px
}

.kyc .ant-radio-checked .ant-radio-inner {
  background-color: var(--ds-color-always-black)!important;
  border-color: var(--ds-color-always-black)!important
}
...
.kyc .ant-form-item-required:before {
  display: none!important
}

.kyc .ant-select-arrow {
  right: 16px!important
}

.kyc .ant-select-selection-search {
  color: var(--ds-color-text-primary)!important
}

.kyc .ant-input:-ms-input-placeholder {
  color: var(--ds-color-text-disabled)!important
}

.kyc .ant-input::placeholder {
  color: var(--ds-color-text-disabled)!important
}

.kyc .ant-input,.kyc .ant-select-selector {
  background: var(--ds-color-background-primary)!important;
...
.kyc .ant-input:link,.kyc .ant-select-selector:link {
  box-shadow: none!important
}

.kyc .ant-input:hover,.kyc .ant-select-selector:hover {
  border-color: var(--ds-color-border-subtle)!important;
  box-shadow: none!important;
  outline: none!important
}

.kyc .ant-input .ant-select-selection-item,.kyc .ant-select-selector .ant-select-selection-item {
  color: var(--ds-color-text-primary)!important;
  font-size: 14px
}

.kyc .ant-input .ant-select-selection-search-input,.kyc .ant-select-selector .ant-select-selection-search-input {
  padding: 0 4px!important
}

.kyc .ant-input .ant-select-item,.kyc .ant-select-selector .ant-select-item {
  padding: 12px 16px
}

.kyc .ant-input .ant-select-selection-placeholder,.kyc .ant-select-selector .ant-select-selection-placeholder {
  color: var(--ds-color-text-disabled)
}

.kyc-ant-select-dropdown {
  background: var(--ds-color-background-primary)!important;
  border-radius: 16px;
  padding: 16px 0
}

.kyc-ant-select-dropdown .ant-select-item {
  padding: 12px 16px!important
}

.kyc-ant-select-dropdown .ant-select-item-option-selected:not(.ant-select-item-option-disabled) {
  background: var(--ds-color-background-secondary)!important;
  color: var(--ds-color-text-primary);
  font-weight: 400!important
}

.kyc-ant-select-dropdown .rc-virtual-list-scrollbar-thumb {
  background-color: var(--ds-color-background-tertiary)!important;
  left: 4px!important;
  width: 4px!important
}
...
.bit-cascader .bit-select-selector {
  border-radius: 48px!important;
  font-size: 14px!important;
  height: 40px!important
}

.bit-cascader .bit-select-selection-item,.bit-cascader .bit-select-selection-placeholder {
  line-height: 40px!important
}

.bit-input-number,.bit-input-number-affix-wrapper {
  background-color: var(--ds-color-text-inverse-primary)!important;
  border-radius: 48px!important
}
...
.ant-select-selection-placeholder,.kyc-manual .ant-select-selection-item {
  line-height: 40px!important
}

.bit-select.bit-select-round .bit-select-selector {
  border-radius: 18px!important
}

.bit-picker-main .bit-picker-input>input {
  font-size: 14px!important
}
...
.bg-ds-color-text-inverse-primary {
  background-color: var(--ds-color-text-inverse-primary)
}

.bg-ds-color-background-primary {
  background-color: var(--ds-color-background-primary)
}

.bg-ds-color-background-secondary {
  background-color: var(--ds-color-background-secondary)
}

.\!bg-\[var\(--ds-color-background-disabled\)\] {
  background-color: var(--ds-color-background-disabled)!important
}

.bg-ds-color-background-mask {
  background-color: var(--ds-color-background-mask)
}

.bg-ds-color-text-primary {
  background-color: var(--ds-color-text-primary)
}

.bg-ds-color-background-inverse-disabled {
  background-color: var(--ds-color-background-inverse-disabled)
}

.bg-ds-color-background-mask-alt {
  background-color: var(--ds-color-background-mask-alt)
}

.bg-ds-color-function-warning {
  background-color: var(--ds-color-function-warning)
}

.bg-ds-color-link-default {
  background-color: var(--ds-color-link-default)
}

.\!bg-ds-color-background-primary {
  background-color: var(--ds-color-background-primary)!important
}

.bg-ds-color-border-subtle {
  background-color: var(--ds-color-border-subtle)
}

.bg-ds-color-always-white {
  background-color: var(--ds-color-always-white)
}

.bg-ds-color-text-disabled {
...
.text-ds-color-function-error {
  color: var(--ds-color-function-error)
}

.text-ds-color-text-inverse-primary {
  color: var(--ds-color-text-inverse-primary)
}

.text-ds-color-always-white {
  color: var(--ds-color-always-white)
}

.text-ds-color-background-primary {
  color: var(--ds-color-background-primary)
}

.text-ds-color-function-success {
  color: var(--ds-color-function-success)
}
...
@media (min-width: 768px) {
  ...
  .md\:bg-ds-color-background-mask-alt {
    background-color: var(--ds-color-background-mask-alt)
  }
  ...
  [dir=ltr] .md\:ltr\:left-\[50\%\] {
    left: 50%
  }

  [dir=ltr] .md\:ltr\:-translate-x-1\/2 {
    --tw-translate-x: -50%;
    transform: translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
  }

  [dir=ltr] .md\:ltr\:-translate-y-1\/2 {
    --tw-translate-y: -50%;
    transform: translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
  }

  [dir=ltr] .ltr\:md\:justify-end {
    justify-content: flex-end
  }
  ...
  [dir=rtl] .md\:rtl\:right-\[50\%\] {
    right: 50%
  }

  [dir=rtl] .md\:rtl\:translate-x-1\/2 {
    --tw-translate-x: 50%;
    transform: translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
  }

  [dir=rtl] .md\:rtl\:-translate-y-1\/2 {
    --tw-translate-y: -50%;
    transform: translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))
  }
...
/*# sourceMappingURL=umi.43aed55d.css.map*/
